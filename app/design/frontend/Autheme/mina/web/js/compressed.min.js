if (function (t, e) {
        ...
        function a(t) {
            var e = {};
            return mt.each(t.match(It) || [], function (t, i) {
                e[i] = !0
            }), e
        }
        ...
        function h() {
            it.removeEventListener("DOMContentLoaded", h), t.removeEventListener("load", h), mt.ready()
        }
        ...
        function f(t, e, i) {
            var n;
            if (void 0 === i && 1 === t.nodeType)if (n = "data-" + e.replace(Pt, "-$&").toLowerCase(), "string" == typeof(i = t.getAttribute(n))) {
                try {
                    i = p(i)
                } catch (t) {
                }
        ...
        function m(t, e, i, n) {
            var o, s = 1, r = 20, a = n ? function () {
                ...
                return mt.css(t, e, "")
            }, l = a(), c = i && i[3] || (mt.cssNumber[e] ? "" : "px"), u = (mt.cssNumber[e] || "px" !== c && +l) && Ht.exec(mt.css(t, e));
            if (u && u[3] !== c) {
                c = c || u[3], i = i || [], u = +l || 1;
                do {
                    s = s || ".5", u /= s, mt.style(t, e, u + c)
                } while (s !== (s = a() / l) && 1 !== s && --r)
            }
        ...
        function g(t) {
            var e, i = t.ownerDocument, n = t.nodeName, o = Bt[n];
            return o || (e = i.body.appendChild(i.createElement(n)), o = mt.css(e, "display"), e.parentNode.removeChild(e), "none" === o && (o = "block"), Bt[n] = o, o)
        }

        function v(t, e) {
            for (var i, n, o = [], s = 0, r = t.length; s < r; s++)n = t[s], n.style && (i = n.style.display, e ? ("none" === i && (o[s] = At.get(n, "display") || null, o[s] || (n.style.display = "")), "" === n.style.display && Ft(n) && (o[s] = g(n))) : "none" !== i && (o[s] = "none", At.set(n, "display", i)));
        ...
        function y(t, e) {
            var i;
            return i = void 0 !== t.getElementsByTagName ? t.getElementsByTagName(e || "*") : void 0 !== t.querySelectorAll ? t.querySelectorAll(e || "*") : [], void 0 === e || e && o(t, e) ? mt.merge([t], i) : i
        }
        ...
        function b(t, e, i, n, o) {
            for (var s, r, a, l, c, u, h = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)if ((s = t[p]) || 0 === s)if ("object" === mt.type(s))mt.merge(d, s.nodeType ? [s] : s); else if (Qt.test(s)) {
                for (r = r || h.appendChild(e.createElement("div")), a = (Yt.exec(s) || ["", ""])[1].toLowerCase(), l = Xt[a] || Xt._default, r.innerHTML = l[1] + mt.htmlPrefilter(s) + l[2], u = l[0]; u--;)r = r.lastChild;
                mt.merge(d, r.childNodes), r = h.firstChild, r.textContent = ""
            } else d.push(e.createTextNode(s));
            for (h.textContent = "", p = 0; s = d[p++];)if (n && mt.inArray(s, n) > -1)o && o.push(s); else if (c = mt.contains(s.ownerDocument, s), r = y(h.appendChild(s), "script"), c && w(r), i)for (u = 0; s = r[u++];)Vt.test(s.type || "") && i.push(s);
            return h
        }
        ...
        function z(t, e) {
            var i, n, o, s, r, a, l, c;
            if (1 === e.nodeType) {
                if (At.hasData(t) && (s = At.access(t), r = At.set(e, s), c = s.events)) {
                    delete r.handle, r.events = {};
                    for (o in c)for (i = 0, n = c[o].length; i < n; i++)mt.event.add(e, o, c[o][i])
                }
        ...
        function I(t, e, n, o) {
            e = st.apply([], e);
            var s, r, a, l, c, u, h = 0, d = t.length, p = d - 1, f = e[0], m = mt.isFunction(f);
            if (m || d > 1 && "string" == typeof f && !pt.checkClone && ie.test(f))return t.each(function (i) {
                var s = t.eq(i);
                m && (e[0] = f.call(this, i, s.html())), I(s, e, n, o)
            });
            if (d && (s = b(e, t[0].ownerDocument, !1, t, o), r = s.firstChild, 1 === s.childNodes.length && (s = r), r || o)) {
                for (a = mt.map(y(s, "script"), E), l = a.length; h < d; h++)c = s, h !== p && (c = mt.clone(c, !0, !0), l && mt.merge(a, y(c, "script"))), n.call(t[h], c, h);
                if (l)for (u = a[a.length - 1].ownerDocument, mt.map(a, k), h = 0; h < l; h++)c = a[h], Vt.test(c.type || "") && !At.access(c, "globalEval") && mt.contains(u, c) && (c.src ? mt._evalUrl && mt._evalUrl(c.src) : i(c.textContent.replace(oe, ""), u))
            }
            return t
        }

        function N(t, e, i) {
            for (var n, o = e ? mt.filter(e, t) : t, s = 0; null != (n = o[s]); s++)i || 1 !== n.nodeType || mt.cleanData(y(n)), n.parentNode && (i && mt.contains(n.ownerDocument, n) && w(y(n, "script")), n.parentNode.removeChild(n));
            return t
        }

        function $(t, e, i) {
            var n, o, s, r, a = t.style;
            return i = i || ae(t), i && (r = i.getPropertyValue(e) || i[e], "" !== r || mt.contains(t.ownerDocument, t) || (r = mt.style(t, e)), !pt.pixelMarginRight() && re.test(r) && se.test(e) && (n = a.width, o = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = i.width, a.width = n, a.minWidth = o, a.maxWidth = s)), void 0 !== r ? r + "" : r
        }
        ...
        function M(t, e, i, n, o) {
            var s, r = 0;
            for (s = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; s < 4; s += 2)"margin" === i && (r += mt.css(t, i + qt[s], !0, o)), n ? ("content" === i && (r -= mt.css(t, "padding" + qt[s], !0, o)), "margin" !== i && (r -= mt.css(t, "border" + qt[s] + "Width", !0, o))) : (r += mt.css(t, "padding" + qt[s], !0, o), "padding" !== i && (r += mt.css(t, "border" + qt[s] + "Width", !0, o)));
            return r
        }

        function P(t, e, i) {
            var n, o = ae(t), s = $(t, e, o), r = "border-box" === mt.css(t, "boxSizing", !1, o);
            return re.test(s) ? s : (n = r && (pt.boxSizingReliable() || s === t.style[e]), "auto" === s && (s = t["offset" + e[0].toUpperCase() + e.slice(1)]), (s = parseFloat(s) || 0) + M(t, e, i || (r ? "border" : "content"), n, o) + "px")
        }
        ...
        function H() {
            me && (!1 === it.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(H) : t.setTimeout(H, mt.fx.interval), mt.fx.tick())
        }
        ...
        function W(t, e, i) {
            for (var n, o = (Y.tweeners[e] || []).concat(Y.tweeners["*"]), s = 0, r = o.length; s < r; s++)if (n = o[s].call(i, e, t))return n
        }

        function B(t, e, i) {
            var n, o, s, r, a, l, c, u, h = "width" in e || "height" in e, d = this, p = {}, f = t.style, m = t.nodeType && Ft(t), g = At.get(t, "fxshow");
            ...
            if ((l = !mt.isEmptyObject(e)) || !mt.isEmptyObject(p)) {
                h && 1 === t.nodeType && (i.overflow = [f.overflow, f.overflowX, f.overflowY], c = g && g.display, null == c && (c = At.get(t, "display")), u = mt.css(t, "display"), "none" === u && (c ? u = c : (v([t], !0), c = t.style.display || c, u = mt.css(t, "display"), v([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === mt.css(t, "float") && (l || (d.done(function () {
                    f.display = c
                }), null == c && (u = f.display, c = "none" === u ? "" : u)), f.display = "inline-block")), i.overflow && (f.overflow = "hidden", d.always(function () {
                    f.overflow = i.overflow[0], f.overflowX = i.overflow[1], f.overflowY = i.overflow[2]
                })), l = !1;
                for (n in p)l || (g ? "hidden" in g && (m = g.hidden) : g = At.access(t, "fxshow", {display: c}), s && (g.hidden = !m), m && v([t], !0), d.done(function () {
                    m || v([t]), At.remove(t, "fxshow");
                    for (n in p)mt.style(t, n, p[n])
                })), l = W(m ? g[n] : 0, n, d), n in g || (g[n] = l.start, m && (l.end = l.start, l.start = 0))
            }
        }

        function U(t, e) {
            var i, n, o, s, r;
            for (i in t)if (n = mt.camelCase(i), o = e[n], s = t[i], Array.isArray(s) && (o = s[1], s = t[i] = s[0]), i !== n && (t[n] = s, delete t[i]), (r = mt.cssHooks[n]) && "expand" in r) {
        ...
        function Y(t, e, i) {
            var n, o, s = 0, r = Y.prefilters.length, a = mt.Deferred().always(function () {
                delete l.elem
            }), l = function () {
                if (o)return !1;
                for (var e = fe || q(), i = Math.max(0, c.startTime + c.duration - e), n = i / c.duration || 0, s = 1 - n, r = 0, l = c.tweens.length; r < l; r++)c.tweens[r].run(s);
            ...
            for (U(u, c.opts.specialEasing); s < r; s++)if (n = Y.prefilters[s].call(c, t, u, c.opts))return mt.isFunction(n.stop) && (mt._queueHooks(c.elem, c.opts.queue).stop = mt.proxy(n.stop, n)), n;
            return mt.map(u, W, c), mt.isFunction(c.opts.start) && c.opts.start.call(t, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), mt.fx.timer(mt.extend(l, {
                elem: t,
                anim: c,
                queue: c.opts.queue
            })), c
        ...
        function Q(t, e, i, n) {
            ...
            }); else if (i || "object" !== mt.type(e))n(t, e); else for (o in e)Q(t + "[" + o + "]", e[o], i, n)
        }
        ...
        function G(t) {
            return function (e, i) {
                ...
                if (mt.isFunction(i))for (; n = s[o++];)"+" === n[0] ? (n = n.slice(1) || "*", (t[n] = t[n] || []).unshift(i)) : (t[n] = t[n] || []).push(i)
            }
        }
        ...
        var et = [], it = t.document, nt = Object.getPrototypeOf, ot = et.slice, st = et.concat, rt = et.push, at = et.indexOf, lt = {}, ct = lt.toString, ut = lt.hasOwnProperty, ht = ut.toString, dt = ht.call(Object), pt = {}, ft = "3.2.1", mt = function (t, e) {
            return new mt.fn.init(t, e)
        }, gt = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, vt = /^-ms-/, yt = /-([a-z])/g, wt = function (t, e) {
        ...
        mt.fn = mt.prototype = {
            ...
            for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == typeof r || mt.isFunction(r) || (r = {}), a === l && (r = this, a--); a < l; a++)if (null != (t = arguments[a]))for (e in t)i = r[e], n = t[e], r !== n && (c && n && (mt.isPlainObject(n) || (o = Array.isArray(n))) ? (o ? (o = !1, s = i && Array.isArray(i) ? i : []) : s = i && mt.isPlainObject(i) ? i : {}, r[e] = mt.extend(c, s, n)) : void 0 !== n && (r[e] = n));
            return r
        }, mt.extend({
            expando: "jQuery" + (ft + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (t) {
                ...
                var e, i;
                return !(!t || "[object Object]" !== ct.call(t) || (e = nt(t)) && ("function" != typeof(i = ut.call(e, "constructor") && e.constructor) || ht.call(i) !== dt))
                ...
                return t.replace(vt, "ms-").replace(yt, wt)
            }, each: function (t, e) {
                var i, o = 0;
                ...
                var i, n, o;
                if ("string" == typeof e && (i = t[e], e = t, t = i), mt.isFunction(t))return n = ot.call(arguments, 2), o = function () {
        ...
        var bt = function (t) {
            function e(t, e, i, n) {
                ...
                if (!n && ((e ? e.ownerDocument || e : R) !== N && I(e), e = e || N, L)) {
                    if (11 !== f && (l = mt.exec(t)))if (o = l[1]) {
                        if (9 === f) {
                            if (!(r = e.getElementById(o)))return i;
                            if (r.id === o)return i.push(r), i
                        } else if (p && (r = p.getElementById(o)) && M(e, r) && r.id === o)return i.push(r), i
                    } else {
                        if (l[2])return G.apply(i, e.getElementsByTagName(t)), i;
                        if ((o = l[3]) && b.getElementsByClassName && e.getElementsByClassName)return G.apply(i, e.getElementsByClassName(o)), i
                    }
                    if (b.qsa && !B[t + " "] && (!O || !O.test(t))) {
                        if (1 !== f)p = e, d = t; else if ("object" !== e.nodeName.toLowerCase()) {
                            for ((a = e.getAttribute("id")) ? a = a.replace(wt, bt) : e.setAttribute("id", a = P), u = S(t), s = u.length; s--;)u[s] = "#" + a + " " + h(u[s]);
            ...
            function d(t, e, i) {
                var n = e.dir, o = e.next, s = o || n, r = i && "parentNode" === s, a = q++;
                return e.first ? function (e, i, o) {
                    ...
                    } else for (; e = e[n];)if (1 === e.nodeType || r)if (h = e[P] || (e[P] = {}), u = h[e.uniqueID] || (h[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase())e = e[n] || e; else {
            ...
            function g(t, e, i, o, s, r) {
                return o && !o[P] && (o = g(o)), s && !s[P] && (s = g(s, r)), n(function (n, r, a, l) {
                    var c, u, h, d = [], p = [], g = r.length, v = n || f(e || "*", a.nodeType ? [a] : a, []), y = !t || !n && e ? v : m(v, d, t, a, l), w = i ? s || (n ? t : g || o) ? [] : r : y;
                    if (i && i(y, w, a, l), o)for (c = m(w, p), o(c, [], a, l), u = c.length; u--;)(h = c[u]) && (w[p[u]] = !(y[p[u]] = h));
                    if (n) {
                        if (s || t) {
                            if (s) {
                            ...
                            for (u = w.length; u--;)(h = w[u]) && (c = s ? K(n, h) : d[u]) > -1 && (n[c] = !(r[c] = h))
                        }
                    } else w = m(w === r ? w.splice(g, w.length) : w), s ? s(null, r, w, l) : G.apply(r, w)
                })
            }

            function v(t) {
                for (var e, i, n, o = t.length, s = _.relative[t[0].type], r = s || _.relative[" "], a = s ? 1 : 0, l = d(function (t) {
                    return t === e
                }, r, !0), c = d(function (t) {
                    return K(e, t) > -1
                    ...
                    return e = null, o
                }]; a < o; a++)if (i = _.relative[t[a].type])u = [d(p(u), i)]; else {
                    if (i = _.filter[t[a].type].apply(null, t[a].matches), i[P]) {
                        for (n = ++a; n < o && !_.relative[t[n].type]; n++);
                        return g(a > 1 && p(u), a > 1 && h(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(st, "$1"), i, a < n && v(t.slice(a, n)), n < o && v(t = t.slice(n)), n < o && h(t))
                    }
                    u.push(i)
                }
                return p(u)
            ...
            function y(t, i) {
                var o = i.length > 0, s = t.length > 0, r = function (n, r, a, l, c) {
                    var u, h, d, p = 0, f = "0", g = n && [], v = [], y = k, w = n || s && _.find.TAG("*", c), b = H += null == y ? 1 : Math.random() || .1, x = w.length;
                    for (c && (k = r === N || r || c); f !== x && null != (u = w[f]); f++) {
                        if (s && u) {
                            for (h = 0, r || u.ownerDocument === N || (I(u), a = !L); d = t[h++];)if (d(u, r || N, a)) {
                                l.push(u);
                                break
                            }
                            c && (H = b)
            ...
            var w, b, _, x, C, S, T, E, k, z, D, I, N, $, L, O, A, j, M, P = "sizzle" + 1 * new Date, R = t.document, H = 0, q = 0, F = i(), W = i(), B = i(), U = function (t, e) {
                return t === e && (D = !0), 0
            }, Y = {}.hasOwnProperty, V = [], X = V.pop, Q = V.push, G = V.push, Z = V.slice, K = function (t, e) {
                for (var i = 0, n = t.length; i < n; i++)if (t[i] === e)return i;
                return -1
            }, J = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", tt = "[\\x20\\t\\r\\n\\f]", et = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", it = "\\[" + tt + "*(" + et + ")(?:" + tt + "*([*^$|!~]?=)" + tt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + et + "))|)" + tt + "*\\]", nt = ":(" + et + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + it + ")*)|.*)\\)|)", ot = new RegExp(tt + "+", "g"), st = new RegExp("^" + tt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + tt + "+$", "g"), rt = new RegExp("^" + tt + "*," + tt + "*"), at = new RegExp("^" + tt + "*([>+~]|" + tt + ")" + tt + "*"), lt = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]", "g"), ct = new RegExp(nt), ut = new RegExp("^" + et + "$"), ht = {
                ID: new RegExp("^#(" + et + ")"),
                CLASS: new RegExp("^\\.(" + et + ")"),
                TAG: new RegExp("^(" + et + "|[*])"),
                ATTR: new RegExp("^" + it),
            ...
            b = e.support = {}, C = e.isXML = function (t) {
                ...
                return n !== N && 9 === n.nodeType && n.documentElement ? (N = n, $ = N.documentElement, L = !C(N), R !== N && (i = N.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", _t, !1) : i.attachEvent && i.attachEvent("onunload", _t)), b.attributes = o(function (t) {
                    return t.className = "i", !t.getAttribute("className")
                }), b.getElementsByTagName = o(function (t) {
                    return t.appendChild(N.createComment("")), !t.getElementsByTagName("*").length
                }), b.getElementsByClassName = ft.test(N.getElementsByClassName), b.getById = o(function (t) {
                    ...
                    }, A = [], O = [], (b.qsa = ft.test(N.querySelectorAll)) && (o(function (t) {
                ...
                })), (b.matchesSelector = ft.test(j = $.matches || $.webkitMatchesSelector || $.mozMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && o(function (t) {
                    b.disconnectedMatch = j.call(t, "*"), j.call(t, "[s!='']:x"), A.push("!=", nt)
                }), O = O.length && new RegExp(O.join("|")), A = A.length && new RegExp(A.join("|")), e = ft.test($.compareDocumentPosition), M = e || ft.test($.contains) ? function (t, e) {
                    ...
                    return i || (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === N || t.ownerDocument === R && M(R, t) ? -1 : e === N || e.ownerDocument === R && M(R, e) ? 1 : z ? K(z, t) - K(z, e) : 0 : 4 & i ? -1 : 1)
                } : function (t, e) {
                    if (t === e)return D = !0, 0;
                    var i, n = 0, o = t.parentNode, s = e.parentNode, a = [t], l = [e];
                    if (!o || !s)return t === N ? -1 : e === N ? 1 : o ? -1 : s ? 1 : z ? K(z, t) - K(z, e) : 0;
                    if (o === s)return r(t, e);
                ...
                if ((t.ownerDocument || t) !== N && I(t), i = i.replace(lt, "='$1']"), b.matchesSelector && L && !B[i + " "] && (!A || !A.test(i)) && (!O || !O.test(i)))try {
                    var n = j.call(t, i);
                ...
                return (t.ownerDocument || t) !== N && I(t), M(t, e)
            }, e.attr = function (t, e) {
                (t.ownerDocument || t) !== N && I(t);
                var i = _.attrHandle[e.toLowerCase()], n = i && Y.call(_.attrHandle, e.toLowerCase()) ? i(t, e, !L) : void 0;
                ...
                var e, i = [], n = 0, o = 0;
                if (D = !b.detectDuplicates, z = !b.sortStable && t.slice(0), t.sort(U), D) {
                ...
                filter: {
                    TAG: function (t) {
                        ...
                        return 1 === n && 0 === o ? function (t) {
                            ...
                            var c, u, h, d, p, f, m = s !== r ? "nextSibling" : "previousSibling", g = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a, w = !1;
                            if (g) {
                                if (s) {
                                    for (; m;) {
                                ...
                                if (f = [r ? g.firstChild : g.lastChild], r && y) {
                                    for (d = g, h = d[P] || (d[P] = {}), u = h[d.uniqueID] || (h[d.uniqueID] = {}), c = u[t] || [], p = c[0] === H && c[1], w = p && c[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (w = p = 0) || f.pop();)if (1 === d.nodeType && ++w && d === e) {
                                        u[t] = [H, p, w];
                                        break
                                    }
                                } else if (y && (d = e, h = d[P] || (d[P] = {}), u = h[d.uniqueID] || (h[d.uniqueID] = {}), c = u[t] || [], p = c[0] === H && c[1], w = p), !1 === w)for (; (d = ++p && d && d[m] || (w = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++w || (y && (h = d[P] || (d[P] = {}), u = h[d.uniqueID] || (h[d.uniqueID] = {}), u[t] = [H, w]), d !== e)););
                                return (w -= o) === n || w % n == 0 && w / n >= 0
                            }
                        }
                    }, PSEUDO: function (t, i) {
                        var o, s = _.pseudos[t] || _.setFilters[t.toLowerCase()] || e.error("unsupported pseudo: " + t);
                        return s[P] ? s(i) : s.length > 1 ? (o = [t, t, "", i], _.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function (t, e) {
            ...
            for (w in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0})_.pseudos[w] = function (t) {
                return function (e) {
                    return "input" === e.nodeName.toLowerCase() && e.type === t
                }
            }(w);
            for (w in{submit: !0, reset: !0})_.pseudos[w] = function (t) {
                return function (e) {
                    var i = e.nodeName.toLowerCase();
            ...
            return u.prototype = _.filters = _.pseudos, _.setFilters = new u, S = e.tokenize = function (t, i) {
                ...
                for (a = t, l = [], c = _.preFilter; a;) {
                    ...
                    for (r in _.filter)!(o = ht[r].exec(a)) || c[r] && !(o = c[r](o)) || (n = o.shift(), s.push({
                        value: n,
                        type: r,
                        matches: o
                    }), a = a.slice(n.length));
                ...
                var i, n = [], o = [], s = B[t + " "];
                if (!s) {
                    for (e || (e = S(t)), i = e.length; i--;)s = v(e[i]), s[P] ? n.push(s) : o.push(s);
                    s = B(t, y(o, n)), s.selector = t
                }
                return s
            }, E = e.select = function (t, e, i, n) {
                var o, s, r, a, l, u = "function" == typeof t && t, d = !n && S(t = u.selector || t);
                if (i = i || [], 1 === d.length) {
                    if (s = d[0] = d[0].slice(0), s.length > 2 && "ID" === (r = s[0]).type && 9 === e.nodeType && L && _.relative[s[1].type]) {
                        if (!(e = (_.find.ID(r.matches[0].replace(vt, yt), e) || [])[0]))return i;
                        u && (e = e.parentNode), t = t.slice(s.shift().value.length)
                    }
                    for (o = ht.needsContext.test(t) ? 0 : s.length; o-- && (r = s[o], !_.relative[a = r.type]);)if ((l = _.find[a]) && (n = l(r.matches[0].replace(vt, yt), gt.test(s[0].type) && c(e.parentNode) || e))) {
                        if (s.splice(o, 1), !(t = n.length && h(s)))return G.apply(i, n), i;
                        break
                    }
                }
                return (u || T(t, d))(n, e, !L, i, !e || gt.test(t) && c(e.parentNode) || e), i
            }, b.sortStable = P.split("").sort(U).join("") === P, b.detectDuplicates = !!D, I(), b.sortDetached = o(function (t) {
        ...
        var _t = function (t, e, i) {
            ...
            return i
        }, Ct = mt.expr.match.needsContext, St = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i, Tt = /^.[^:#\[\.,]*$/;
        ...
        (mt.fn.init = function (t, e, i) {
            ...
            if (i = i || Et, "string" == typeof t) {
                ...
                if (n[1]) {
                    if (e = e instanceof mt ? e[0] : e, mt.merge(this, mt.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : it, !0)), St.test(n[1]) && mt.isPlainObject(e))for (n in e)mt.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                    return this
                }
        ...
        }).prototype = mt.fn, Et = mt(it);
        var zt = /^(?:parents|prev(?:Until|All))/, Dt = {children: !0, contents: !0, next: !0, prev: !0};
        mt.fn.extend({
            has: function (t) {
                ...
                var i, n = 0, o = this.length, s = [], r = "string" != typeof t && mt(t);
                if (!Ct.test(t))for (; n < o; n++)for (i = this[n]; i && i !== e; i = i.parentNode)if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && mt.find.matchesSelector(i, t))) {
                    s.push(i);
                    break
                }
            ...
            mt.fn[t] = function (i, n) {
                ...
                return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (o = mt.filter(n, o)), this.length > 1 && (Dt[t] || mt.uniqueSort(o), zt.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var It = /[^\x20\t\r\n\f]+/g;
        mt.Callbacks = function (t) {
            ...
            var e, i, n, o, s = [], r = [], l = -1, c = function () {
                for (o = o || t.once, n = e = !0; r.length; l = -1)for (i = r.shift(); ++l < s.length;)!1 === s[l].apply(i[0], i[1]) && t.stopOnFalse && (l = s.length, i = !1);
                t.memory || (i = !1), e = !1, o && (s = i ? [] : "")
            }, u = {
                add: function () {
                    return s && (i && !e && (l = s.length - 1, r.push(i)), function e(i) {
                        mt.each(i, function (i, n) {
                            mt.isFunction(n) ? t.unique && u.has(n) || s.push(n) : n && n.length && "string" !== mt.type(n) && e(n)
                        })
                    }(arguments), i && !e && c()), this
                }, remove: function () {
                    return mt.each(arguments, function (t, e) {
                        for (var i; (i = mt.inArray(e, s, i)) > -1;)s.splice(i, 1), i <= l && l--
                    }), this
                }, has: function (t) {
            ...
            Deferred: function (e) {
                var i = [["notify", "progress", mt.Callbacks("memory"), mt.Callbacks("memory"), 2], ["resolve", "done", mt.Callbacks("once memory"), mt.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", mt.Callbacks("once memory"), mt.Callbacks("once memory"), 1, "rejected"]], n = "pending", o = {
                    state: function () {
                        return n
                    }, always: function () {
                            ...
                            return function () {
                                var a = this, u = arguments, h = function () {
                                    ...
                                    if (!(e < r)) {
                                        ...
                                        h = t && ("object" == typeof t || "function" == typeof t) && t.then, mt.isFunction(h) ? o ? h.call(t, s(r, i, l, o), s(r, i, c, o)) : (r++, h.call(t, s(r, i, l, o), s(r, i, c, o), s(r, i, l, i.notifyWith))) : (n !== l && (a = void 0, u = [t]), (o || i.resolveWith)(a, u))
                                    }
                                }, d = o ? h : function () {
                                    try {
                                        h()
                                    } catch (t) {
                                        mt.Deferred.exceptionHook && mt.Deferred.exceptionHook(t, d.stackTrace), e + 1 >= r && (n !== c && (a = void 0, u = [t]), i.rejectWith(a, u))
                                    }
                                };
                ...
                var e = arguments.length, i = e, n = Array(i), o = ot.call(arguments), s = mt.Deferred(), r = function (t) {
                    return function (i) {
                        n[t] = this, o[t] = arguments.length > 1 ? ot.call(arguments) : i, --e || s.resolveWith(n, o)
                    }
                };
                if (e <= 1 && (u(t, s.done(r(i)).resolve, s.reject, !e), "pending" === s.state() || mt.isFunction(o[i] && o[i].then)))return s.then();
        ...
        mt.fn.ready = function (t) {
            ...
            isReady: !1, readyWait: 1, ready: function (t) {
                (!0 === t ? --mt.readyWait : mt.isReady) || (mt.isReady = !0, !0 !== t && --mt.readyWait > 0 || $t.resolveWith(it, [mt]))
            }
        }), mt.ready.then = $t.then, "complete" === it.readyState || "loading" !== it.readyState && !it.documentElement.doScroll ? t.setTimeout(mt.ready) : (it.addEventListener("DOMContentLoaded", h), t.addEventListener("load", h));
        ...
        d.uid = 1, d.prototype = {
            cache: function (t) {
                ...
                if ("string" == typeof e)o[mt.camelCase(e)] = i; else for (n in e)o[mt.camelCase(n)] = e[n];
                return o
            }, get: function (t, e) {
                ...
                if (void 0 !== n) {
                    if (void 0 !== e) {
                        Array.isArray(e) ? e = e.map(mt.camelCase) : (e = mt.camelCase(e), e = e in n ? [e] : e.match(It) || []), i = e.length;
                        for (; i--;)delete n[e[i]]
                    }
        ...
        var At = new d, jt = new d, Mt = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Pt = /[A-Z]/g;
        mt.extend({
            hasData: function (t) {
            ...
            data: function (t, e) {
                ...
                if (void 0 === t) {
                    if (this.length && (o = jt.get(s), 1 === s.nodeType && !At.get(s, "hasDataAttrs"))) {
            ...
            queue: function (t, e, i) {
                var n;
                if (t)return e = (e || "fx") + "queue", n = At.get(t, e), i && (!n || Array.isArray(i) ? n = At.access(t, e, mt.makeArray(i)) : n.push(i)), n || []
            }, dequeue: function (t, e) {
                e = e || "fx";
                var i = mt.queue(t, e), n = i.length, o = i.shift(), s = mt._queueHooks(t, e), r = function () {
                    mt.dequeue(t, e)
                };
            ...
            queue: function (t, e) {
                ...
                var i, n = 1, o = mt.Deferred(), s = this, r = this.length, a = function () {
                    --n || o.resolveWith(s, [s])
                };
        ...
        var Rt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ht = new RegExp("^(?:([+-])=|)(" + Rt + ")([a-z%]*)$", "i"), qt = ["Top", "Right", "Bottom", "Left"], Ft = function (t, e) {
        ...
        mt.fn.extend({
            show: function () {
                ...
                return "boolean" == typeof t ? t ? this.show() : this.hide() : this.each(function () {
                    Ft(this) ? mt(this).show() : mt(this).hide()
                })
            }
        });
        ...
        var Gt = it.documentElement, Zt = /^key/, Kt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Jt = /^([^.]*)(?:\.(.+)|)/;
        mt.event = {
            global: {}, add: function (t, e, i, n, o) {
                var s, r, a, l, c, u, h, d, p, f, m, g = At.get(t);
                if (g)for (i.handler && (s = i, i = s.handler, o = s.selector), o && mt.find.matchesSelector(Gt, o), i.guid || (i.guid = mt.guid++), (l = g.events) || (l = g.events = {}), (r = g.handle) || (r = g.handle = function (e) {
                    return void 0 !== mt && mt.event.triggered !== e.type ? mt.event.dispatch.apply(t, arguments) : void 0
                }), e = (e || "").match(It) || [""], c = e.length; c--;)a = Jt.exec(e[c]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p && (h = mt.event.special[p] || {}, p = (o ? h.delegateType : h.bindType) || p, h = mt.event.special[p] || {}, u = mt.extend({
                    type: p,
                    origType: m,
                    data: n,
                    handler: i,
                    ...
                    namespace: f.join(".")
                }, s), (d = l[p]) || (d = l[p] = [], d.delegateCount = 0, h.setup && !1 !== h.setup.call(t, n, f, r) || t.addEventListener && t.addEventListener(p, r)), h.add && (h.add.call(t, u), u.handler.guid || (u.handler.guid = i.guid)), o ? d.splice(d.delegateCount++, 0, u) : d.push(u), mt.event.global[p] = !0)
            }, remove: function (t, e, i, n, o) {
                var s, r, a, l, c, u, h, d, p, f, m, g = At.hasData(t) && At.get(t);
                if (g && (l = g.events)) {
                    for (e = (e || "").match(It) || [""], c = e.length; c--;)if (a = Jt.exec(e[c]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                        for (h = mt.event.special[p] || {}, p = (n ? h.delegateType : h.bindType) || p, d = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = s = d.length; s--;)u = d[s], !o && m !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (d.splice(s, 1), u.selector && d.delegateCount--, h.remove && h.remove.call(t, u));
                        r && !d.length && (h.teardown && !1 !== h.teardown.call(t, f, g.handle) || mt.removeEvent(t, p, g.handle), delete l[p])
                    } else for (p in l)mt.event.remove(t, p + e[c], i, n, !0);
                    mt.isEmptyObject(l) && At.remove(t, "handle events")
                }
            }, dispatch: function (t) {
                var e, i, n, o, s, r, a = mt.event.fix(t), l = new Array(arguments.length), c = (At.get(this, "events") || {})[a.type] || [], u = mt.event.special[a.type] || {};
                ...
                if (l && c.nodeType && !("click" === t.type && t.button >= 1))for (; c !== this; c = c.parentNode || this)if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                    for (s = [], r = {}, i = 0; i < l; i++)n = e[i], o = n.selector + " ", void 0 === r[o] && (r[o] = n.needsContext ? mt(o, this).index(c) > -1 : mt.find(o, this, null, [c]).length), r[o] && s.push(n);
        ...
        var te = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, ee = /<script|<style|<link/i, ie = /checked\s*(?:[^=]|=\s*.checked.)/i, ne = /^true\/(.*)/, oe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
        mt.extend({
            htmlPrefilter: function (t) {
                return t.replace(te, "<$1></$2>")
            }, clone: function (t, e, i) {
                var n, o, s, r, a = t.cloneNode(!0), l = mt.contains(t.ownerDocument, t);
                if (!(pt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || mt.isXMLDoc(t)))for (r = y(a), s = y(t), n = 0, o = s.length; n < o; n++)D(s[n], r[n]);
                if (e)if (i)for (s = s || y(t), r = r || y(a), n = 0, o = s.length; n < o; n++)z(s[n], r[n]); else z(t, a);
                return r = y(a, "script"), r.length > 0 && w(r, !l && y(t, "script")), a
            }, cleanData: function (t) {
                for (var e, i, n, o = mt.event.special, s = 0; void 0 !== (i = t[s]); s++)if (Ot(i)) {
                    if (e = i[At.expando]) {
            ...
            detach: function (t) {
                ...
                return Lt(this, function (t) {
                    ...
                    if ("string" == typeof t && !ee.test(t) && !Xt[(Yt.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = mt.htmlPrefilter(t);
                        try {
                            for (; i < n; i++)e = this[i] || {}, 1 === e.nodeType && (mt.cleanData(y(e, !1)), e.innerHTML = t);
                            e = 0
                        } catch (t) {
                        }
                    }
            ...
            mt.fn[t] = function (t) {
                for (var i, n = [], o = mt(t), s = o.length - 1, r = 0; r <= s; r++)i = r === s ? this : this.clone(!0), mt(o[r])[e](i), rt.apply(n, i.get());
        ...
        var le = /^(none|table(?!-c[ea]).+)/, ce = /^--/, ue = {
            ...
            letterSpacing: "0",
            fontWeight: "400"
        }, de = ["Webkit", "Moz", "ms"], pe = it.createElement("div").style;
        mt.extend({
            cssHooks: {
                opacity: {
                    get: function (t, e) {
            ...
            style: function (t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var o, s, r, a = mt.camelCase(e), l = ce.test(e), c = t.style;
            ...
            css: function (t, e, i, n) {
                ...
                return ce.test(e) || (e = A(a)), r = mt.cssHooks[e] || mt.cssHooks[a], r && "get" in r && (o = r.get(t, !0, i)), void 0 === o && (o = $(t, e, n)), "normal" === o && e in he && (o = he[e]), "" === i || i ? (s = parseFloat(o), !0 === i || isFinite(s) ? s || 0 : o) : o
            }
        }), mt.each(["height", "width"], function (t, e) {
            mt.cssHooks[e] = {
                get: function (t, i, n) {
                    if (i)return !le.test(mt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? P(t, e, n) : Wt(t, ue, function () {
                        return P(t, e, n)
                    })
                }, set: function (t, i, n) {
                    var o, s = n && ae(t), r = n && M(t, e, n, "border-box" === mt.css(t, "boxSizing", !1, s), s);
                    return r && (o = Ht.exec(i)) && "px" !== (o[3] || "px") && (t.style[e] = i, i = mt.css(t, e)), j(t, i, r)
                }
            }
        }), mt.cssHooks.marginLeft = L(pt.reliableMarginLeft, function (t, e) {
            if (e)return (parseFloat($(t, "marginLeft")) || t.getBoundingClientRect().left - Wt(t, {marginLeft: 0}, function () {
            ...
            }, se.test(t) || (mt.cssHooks[t + e].set = j)
        }), mt.fn.extend({
            css: function (t, e) {
                return Lt(this, function (t, e, i) {
                    var n, o, s = {}, r = 0;
                    if (Array.isArray(e)) {
                        for (n = ae(t), o = e.length; r < o; r++)s[e[r]] = mt.css(t, e[r], !1, n);
                        return s
                    }
        ...
        var fe, me, ge = /^(?:toggle|show|hide)$/, ve = /queueHooks$/;
        mt.Animation = mt.extend(Y, {
            tweeners: {
                ...
                for (var i, n = 0, o = t.length; n < o; n++)i = t[n], Y.tweeners[i] = Y.tweeners[i] || [], Y.tweeners[i].unshift(e)
            ...
            fadeTo: function (t, e, i, n) {
                ...
                var o = mt.isEmptyObject(t), s = mt.speed(e, i, n), r = function () {
                ...
                return "string" != typeof t && (i = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function () {
                    var e = !0, o = null != t && t + "queueHooks", s = mt.timers, r = At.get(this);
                ...
                return !1 !== t && (t = t || "fx"), this.each(function () {
                    var e, i = At.get(this), n = i[t + "queue"], o = i[t + "queueHooks"], s = mt.timers, r = n ? n.length : 0;
            ...
            var t = it.createElement("input"), e = it.createElement("select"), i = e.appendChild(it.createElement("option"));
        ...
        mt.fn.extend({
            ...
            attr: function (t, e, i) {
                ...
                if (3 !== s && 8 !== s && 2 !== s)return void 0 === t.getAttribute ? mt.prop(t, e, i) : (1 === s && mt.isXMLDoc(t) || (o = mt.attrHooks[e.toLowerCase()] || (mt.expr.match.bool.test(e) ? ye : void 0)), void 0 !== i ? null === i ? void mt.removeAttr(t, e) : o && "set" in o && void 0 !== (n = o.set(t, i, e)) ? n : (t.setAttribute(e, i + ""), i) : o && "get" in o && null !== (n = o.get(t, e)) ? n : (n = mt.find.attr(t, e), null == n ? void 0 : n))
            }, attrHooks: {
                type: {
                    set: function (t, e) {
            ...
            var i = we[e] || mt.find.attr;
            we[e] = function (t, e, n) {
                var o, s, r = e.toLowerCase();
                return n || (s = we[r], we[r] = o, o = null != i(t, e, n) ? r : null, we[r] = s), o
            }
        });
        ...
        mt.fn.extend({
            ...
            prop: function (t, e, i) {
                var n, o, s = t.nodeType;
                if (3 !== s && 8 !== s && 2 !== s)return 1 === s && mt.isXMLDoc(t) || (e = mt.propFix[e] || e, o = mt.propHooks[e]), void 0 !== i ? o && "set" in o && void 0 !== (n = o.set(t, i, e)) ? n : t[e] = i : o && "get" in o && null !== (n = o.get(t, e)) ? n : t[e]
            }, propHooks: {
                tabIndex: {
                    get: function (t) {
            ...
            addClass: function (t) {
                ...
                if ("string" == typeof t && t)for (e = t.match(It) || []; i = this[l++];)if (o = X(i), n = 1 === i.nodeType && " " + V(o) + " ") {
                ...
                return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : mt.isFunction(t) ? this.each(function (i) {
                    mt(this).toggleClass(t.call(this, i, X(this), e), e)
                }) : this.each(function () {
                    var e, n, o, s;
                    if ("string" === i)for (n = 0, o = mt(this), s = t.match(It) || []; e = s[n++];)o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else void 0 !== t && "boolean" !== i || (e = X(this), e && At.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : At.get(this, "__className__") || ""))
                })
            }, hasClass: function (t) {
                var e, i, n = 0;
                for (e = " " + t + " "; i = this[n++];)if (1 === i.nodeType && (" " + V(X(i)) + " ").indexOf(e) > -1)return !0;
                return !1
            }
        });
        var xe = /\r/g;
        mt.fn.extend({
            val: function (t) {
                ...
                })) : o ? (e = mt.valHooks[o.type] || mt.valHooks[o.nodeName.toLowerCase()], e && "get" in e && void 0 !== (i = e.get(o, "value")) ? i : (i = o.value, "string" == typeof i ? i.replace(xe, "") : null == i ? "" : i)) : void 0
            }
        }), mt.extend({
            valHooks: {
                option: {
                    ...
                    get: function (t) {
                        var e, i, n, s = t.options, r = t.selectedIndex, a = "select-one" === t.type, l = a ? null : [], c = a ? r + 1 : s.length;
        ...
        mt.extend(mt.event, {
            trigger: function (e, i, n, o) {
                var s, r, a, l, c, u, h, d = [n || it], p = ut.call(e, "type") ? e.type : e, f = ut.call(e, "namespace") ? e.namespace.split(".") : [];
                if (r = a = n = n || it, 3 !== n.nodeType && 8 !== n.nodeType && !Ce.test(p + mt.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), c = p.indexOf(":") < 0 && "on" + p, e = e[mt.expando] ? e : new mt.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : mt.makeArray(i, [e]), h = mt.event.special[p] || {}, o || !h.trigger || !1 !== h.trigger.apply(n, i))) {
                    ...
                    for (s = 0; (r = d[s++]) && !e.isPropagationStopped();)e.type = s > 1 ? l : h.bindType || p, u = (At.get(r, "events") || {})[e.type] && At.get(r, "handle"), u && u.apply(r, i), (u = c && r[c]) && u.apply && Ot(r) && (e.result = u.apply(r, i), !1 === e.result && e.preventDefault());
                    return e.type = p, o || e.isDefaultPrevented() || h._default && !1 !== h._default.apply(d.pop(), i) || !Ot(n) || c && mt.isFunction(n[p]) && !mt.isWindow(n) && (a = n[c], a && (n[c] = null), mt.event.triggered = p, n[p](), mt.event.triggered = void 0, a && (n[c] = a)), e.result
                }
            ...
            mt.event.special[e] = {
                setup: function () {
                    var n = this.ownerDocument || this, o = At.access(n, e);
                    o || n.addEventListener(t, i, !0), At.access(n, e, (o || 0) + 1)
                }, teardown: function () {
                    var n = this.ownerDocument || this, o = At.access(n, e) - 1;
                    o ? At.access(n, e, o) : (n.removeEventListener(t, i, !0), At.remove(n, e))
                }
            }
        });
        var Se = t.location, Te = mt.now(), Ee = /\?/;
        ...
        var ke = /\[\]$/, ze = /\r?\n/g, De = /^(?:submit|button|image|reset|file)$/i, Ie = /^(?:input|select|textarea|keygen)/i;
        ...
        var Ne = /%20/g, $e = /#.*$/, Le = /([?&])_=[^&]*/, Oe = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ae = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, je = /^(?:GET|HEAD)$/, Me = /^\/\//, Pe = {}, Re = {}, He = "*/".concat("*"), qe = it.createElement("a");
        qe.href = Se.href, mt.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajaxSetup: function (t, e) {
                return e ? K(K(t, mt.ajaxSettings), e) : K(mt.ajaxSettings, t)
            },
            ajaxPrefilter: G(Pe),
            ajaxTransport: G(Re),
            ajax: function (e, i) {
                ...
                var o, s, r, a, l, c, u, h, d, p, f = mt.ajaxSetup({}, i), m = f.context || f, g = f.context && (m.nodeType || m.jquery) ? mt(m) : mt.event, v = mt.Deferred(), y = mt.Callbacks("once memory"), w = f.statusCode || {}, b = {}, _ = {}, x = "canceled", C = {
                    readyState: 0,
                    ...
                    statusCode: function (t) {
                        var e;
                        if (t)if (u)C.always(t[C.status]); else for (e in t)w[e] = [w[e], t[e]];
                        return this
                    },
                    abort: function (t) {
                        var e = t || x;
                ...
                if (v.promise(C), f.url = ((e || f.url || Se.href) + "").replace(Me, Se.protocol + "//"), f.type = i.method || i.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(It) || [""], null == f.crossDomain) {
                ...
                if (f.data && f.processData && "string" != typeof f.data && (f.data = mt.param(f.data, f.traditional)), Z(Pe, f, i, C), u)return C;
                ...
                if (x = "abort", y.add(f.complete), C.done(f.success), C.fail(f.error), o = Z(Re, f, i, C)) {
        ...
        var Fe = {0: 200, 1223: 204}, We = mt.ajaxSettings.xhr();
        pt.cors = !!We && "withCredentials" in We, pt.ajax = We = !!We, mt.ajaxTransport(function (e) {
            var i, n;
            if (pt.cors || We && !e.crossDomain)return {
                send: function (o, s) {
                    ...
                    i = function (t) {
                        return function () {
                            i && (i = n = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? s(0, "error") : s(a.status, a.statusText) : s(Fe[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                        }
        ...
        mt.ajaxSetup({
            ...
            if (a || "jsonp" === e.dataTypes[0])return o = e.jsonpCallback = mt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ue, "$1" + o) : !1 !== e.jsonp && (e.url += (Ee.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
                return r || mt.error(o + " was not called"), r[0]
            }, e.dataTypes[0] = "json", s = t[o], t[o] = function () {
                r = arguments
            }, n.always(function () {
                void 0 === s ? mt(t).removeProp(o) : t[o] = s, e[o] && (e.jsonpCallback = i.jsonpCallback, Be.push(o)), r && mt.isFunction(s) && s(r[0]), r = s = void 0
            }), "script"
            ...
            var n, o, s;
            return e || (pt.createHTMLDocument ? (e = it.implementation.createHTMLDocument(""), n = e.createElement("base"), n.href = it.location.href, e.head.appendChild(n)) : e = it), o = St.exec(t), s = !i && [], o ? [e.createElement(o[1])] : (o = b([t], e, s), s && s.length && mt(s).remove(), mt.merge([], o.childNodes))
        }, mt.fn.load = function (t, e, i) {
            var n, o, s, r = this, a = t.indexOf(" ");
            return a > -1 && (n = V(t.slice(a)), t = t.slice(0, a)), mt.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (o = "POST"), r.length > 0 && mt.ajax({
                url: t,
                type: o || "GET",
                dataType: "html",
                data: e
            ...
            setOffset: function (t, e, i) {
                var n, o, s, r, a, l, c, u = mt.css(t, "position"), h = mt(t), d = {};
            ...
            mt.cssHooks[e] = L(pt.pixelPosition, function (t, i) {
                if (i)return i = $(t, e), re.test(i) ? mt(t).position()[e] + "px" : i
            })
...
+function (t) {
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        var h = /top|bottom/.test(i), d = h ? 2 * u.left - o + l : 2 * u.top - s + c, p = h ? "offsetWidth" : "offsetHeight";
        ...
        var s = window.SVGElement && i instanceof window.SVGElement, r = n ? {
            top: 0,
            left: 0
        } : s ? null : e.offset(), a = {scroll: n ? document.documentElement.scrollTop || document.body.scrollTop : e.scrollTop()}, l = n ? {
    ...
    "use strict";
    var e = !1, i = !1, n = 0, o = 2e3, s = 0, r = t, a = document, l = window, c = r(l), u = [], h = l.requestAnimationFrame || l.webkitRequestAnimationFrame || l.mozRequestAnimationFrame || !1, d = l.cancelAnimationFrame || l.webkitCancelAnimationFrame || l.mozCancelAnimationFrame || !1;
    if (h)l.cancelAnimationFrame || (d = function (t) {
    }); else {
        var p = 0;
        h = function (t, e) {
            var i = (new Date).getTime(), n = Math.max(0, 16 - (i - p)), o = l.setTimeout(function () {
                t(i + n)
            }, n);
            return p = i + n, o
        }, d = function (t) {
    ...
    var f = l.MutationObserver || l.WebKitMutationObserver || !1, m = Date.now || function () {
        ...
        scriptpath: function () {
            var t = a.currentScript || function () {
        ...
        if (v)return v;
        var t = a.createElement("DIV"), e = t.style, i = navigator.userAgent, n = navigator.platform, o = {};
        return o.haspointerlock = "pointerLockElement" in a || "webkitPointerLockElement" in a || "mozPointerLockElement" in a, o.isopera = "opera" in l, o.isopera12 = o.isopera && "getUserMedia" in navigator, o.isoperamini = "[object OperaMini]" === Object.prototype.toString.call(l.operamini), o.isie = "all" in a && "attachEvent" in t && !o.isopera, o.isieold = o.isie && !("msInterpolationMode" in e), o.isie7 = o.isie && !o.isieold && (!("documentMode" in a) || 7 === a.documentMode), o.isie8 = o.isie && "documentMode" in a && 8 === a.documentMode, o.isie9 = o.isie && "performance" in l && 9 === a.documentMode, o.isie10 = o.isie && "performance" in l && 10 === a.documentMode, o.isie11 = "msRequestFullscreen" in t && a.documentMode >= 11, o.ismsedge = "msCredentials" in l, o.ismozilla = "MozAppearance" in e, o.iswebkit = !o.ismsedge && "WebkitAppearance" in e, o.ischrome = o.iswebkit && "chrome" in l, o.ischrome38 = o.ischrome && "touchAction" in e, o.ischrome22 = !o.ischrome38 && o.ischrome && o.haspointerlock, o.ischrome26 = !o.ischrome38 && o.ischrome && "transition" in e, o.cantouch = "ontouchstart" in a.documentElement || "ontouchstart" in l, o.hasw3ctouch = (l.PointerEvent || !1) && (navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0), o.hasmstouch = !o.hasw3ctouch && (l.MSPointerEvent || !1), o.ismac = /^mac$/i.test(n), o.isios = o.cantouch && /iphone|ipad|ipod/i.test(n), o.isios4 = o.isios && !("seal" in Object), o.isios7 = o.isios && "webkitHidden" in a, o.isios8 = o.isios && "hidden" in a, o.isios10 = o.isios && l.Proxy, o.isandroid = /android/i.test(i), o.haseventlistener = "addEventListener" in t, o.trstyle = !1, o.hastransform = !1, o.hastranslate3d = !1, o.transitionstyle = !1, o.hastransition = !1, o.transitionend = !1, o.trstyle = "transform", o.hastransform = "transform" in e || function () {
                for (var t = ["msTransform", "webkitTransform", "MozTransform", "OTransform"], i = 0, n = t.length; i < n; i++)if (void 0 !== e[t[i]]) {
                    o.trstyle = t[i];
                    break
                }
                o.hastransform = !!o.trstyle
            }(), o.hastransform && (e[o.trstyle] = "translate3d(1px,2px,3px)", o.hastranslate3d = /translate3d/.test(e[o.trstyle])), o.transitionstyle = "transition", o.prefixstyle = "", o.transitionend = "transitionend",
            o.hastransition = "transition" in e || function () {
                    o.transitionend = !1;
                    for (var t = ["webkitTransition", "msTransition", "MozTransition", "OTransition", "OTransition", "KhtmlTransition"], i = ["-webkit-", "-ms-", "-moz-", "-o-", "-o", "-khtml-"], n = ["webkitTransitionEnd", "msTransitionEnd", "transitionend", "otransitionend", "oTransitionEnd", "KhtmlTransitionEnd"], s = 0, r = t.length; s < r; s++)if (t[s] in e) {
                        o.transitionstyle = t[s], o.prefixstyle = i[s], o.transitionend = n[s];
                        break
                    }
                    o.ischrome26 && (o.prefixstyle = i[1]), o.hastransition = o.transitionstyle
                }(), o.cursorgrabvalue = function () {
            var t = ["grab", "-webkit-grab", "-moz-grab"];
            (o.ischrome && !o.ischrome38 || o.isie) && (t = []);
            for (var i = 0, n = t.length; i < n; i++) {
                var s = t[i];
                if (e.cursor = s, e.cursor == s)return s
            }
            return "url(https://cdnjs.cloudflare.com/ajax/libs/slider-pro/1.3.0/css/images/openhand.cur),n-resize"
        }(), o.hasmousecapture = "setCapture" in t, o.hasMutationObserver = !1 !== f, t = null, v = o, o
    }, w = function (t, p) {
        function v() {
            var t = T.doc.css(N.trstyle);
        ...
        function _(t, e, i) {
            var n = t.css(e), o = parseFloat(n);
            if (isNaN(o)) {
                var s = 3 == (o = O[n] || 0) ? i ? T.win.outerHeight() - T.win.innerHeight() : T.win.outerWidth() - T.win.innerWidth() : 1;
                return T.isie8 && o && (o += 1), s ? o : 0
            }
            return o
        }

        function x(t, e, i, n) {
            T._bind(t, e, function (n) {
                var o = {
        ...
        function C(t, e, i, n) {
            T.scrollrunning || (T.newscrolly = T.getScrollTop(), T.newscrollx = T.getScrollLeft(), H = m());
            var o = m() - H;
            if (H = m(), o > 350 ? q = 1 : q += (2 - q) / 10, t = t * q | 0, e = e * q | 0, t) {
                if (n)if (t < 0) {
                    if (T.getScrollLeft() >= T.page.maxw)return !0
                } else if (T.getScrollLeft() <= 0)return !0;
                var s = t > 0 ? 1 : -1;
                R !== s && (T.scrollmom && T.scrollmom.stop(), T.newscrollx = T.getScrollLeft(), R = s), T.lastdeltax -= t
            }
            if (e) {
                if (function () {
                        var t = T.getScrollTop();
                        if (e < 0) {
                            if (t >= T.page.maxh)return !0
                        } else if (t <= 0)return !0
                    }()) {
                    if (k.nativeparentscrolling && i && !T.ispage && !T.zoomactive)return !0;
                    var r = T.view.h >> 1;
                    T.newscrolly < -r ? (T.newscrolly = -r, e = -1) : T.newscrolly > T.page.maxh + r ? (T.newscrolly = T.page.maxh + r, e = 1) : e = 0
                }
                var a = e > 0 ? 1 : -1;
                P !== a && (T.scrollmom && T.scrollmom.stop(), T.newscrolly = T.getScrollTop(), P = a), T.lastdeltay -= e
            }
            (e || t) && T.synched("relativexy", function () {
                var t = T.lastdeltay + T.newscrolly;
                T.lastdeltay = 0;
                var e = T.lastdeltax + T.newscrollx;
                T.lastdeltax = 0, T.rail.drag || T.doScrollPos(e, t)
            })
        }

        function S(t, e, i) {
            var n, o;
            return !(i || !F) || (0 === t.deltaMode ? (n = -t.deltaX * (k.mousescrollstep / 54) | 0, o = -t.deltaY * (k.mousescrollstep / 54) | 0) : 1 === t.deltaMode && (n = -t.deltaX * k.mousescrollstep * 50 / 80 | 0, o = -t.deltaY * k.mousescrollstep * 50 / 80 | 0), e && k.oneaxismousemode && 0 === n && o && (n = o, o = 0, i && (n < 0 ? T.getScrollLeft() >= T.page.maxw : T.getScrollLeft() <= 0) && (o = n, n = 0)), T.isrtlmode && (n = -n), C(n, o, i, !0) ? void(i && (F = !0)) : (F = !1, t.stopImmediatePropagation(), t.preventDefault()))
        }

        var T = this;
        this.version = "3.7.6", this.name = "nicescroll", this.me = p;
        var E = r("body"), k = this.opt = {doc: E, win: !1};
        if (r.extend(k, g), k.snapbackspeed = 80, t)for (var z in k)void 0 !== t[z] && (k[z] = t[z]);
        if (k.disablemutationobserver && (f = !1), this.doc = k.doc, this.iddoc = this.doc && this.doc[0] ? this.doc[0].id || "" : "", this.ispage = /^BODY|HTML/.test(k.win ? k.win[0].nodeName : this.doc[0].nodeName), this.haswrapper = !1 !== k.win, this.win = k.win || (this.ispage ? c : this.doc), this.docscroll = this.ispage && !this.haswrapper ? c : this.win, this.body = E, this.viewport = !1, this.isfixed = !1, this.iframe = !1, this.isiframe = "IFRAME" == this.doc[0].nodeName && "IFRAME" == this.win[0].nodeName, this.istextarea = "TEXTAREA" == this.win[0].nodeName, this.forcescreen = !1, this.canshowonmouseevent = "scroll" != k.autohidemode, this.onmousedown = !1, this.onmouseup = !1, this.onmousemove = !1, this.onmousewheel = !1, this.onkeypress = !1, this.ongesturezoom = !1, this.onclick = !1, this.onscrollstart = !1, this.onscrollend = !1, this.onscrollcancel = !1, this.onzoomin = !1, this.onzoomout = !1, this.view = !1, this.page = !1, this.scroll = {
                x: 0,
                y: 0
            }, this.scrollratio = {x: 0, y: 0}, this.cursorheight = 20, this.scrollvaluemax = 0, "auto" == k.rtlmode) {
            var D = this.win[0] == l ? this.body : this.win, I = D.css("writing-mode") || D.css("-webkit-writing-mode") || D.css("-ms-writing-mode") || D.css("-moz-writing-mode");
            "horizontal-tb" == I || "lr-tb" == I || "" === I ? (this.isrtlmode = "rtl" == D.css("direction"), this.isvertical = !1) : (this.isrtlmode = "vertical-rl" == I || "tb" == I || "tb-rl" == I || "rl-tb" == I, this.isvertical = "vertical-rl" == I || "tb" == I || "tb-rl" == I)
        } else this.isrtlmode = !0 === k.rtlmode, this.isvertical = !1;
        if (this.scrollrunning = !1, this.scrollmom = !1, this.observer = !1, this.observerremover = !1, this.observerbody = !1, !1 !== k.scrollbarid)this.id = k.scrollbarid; else do {
            this.id = "ascrail" + o++
        ...
        var N = r.extend({}, this.detected);
        this.canhwscroll = N.hastransform && k.hwacceleration, this.ishwscroll = this.canhwscroll && T.haswrapper, this.isrtlmode ? this.isvertical ? this.hasreversehr = !(N.iswebkit || N.isie || N.isie11) : this.hasreversehr = !(N.iswebkit || N.isie && !N.isie10 && !N.isie11) : this.hasreversehr = !1, this.istouchcapable = !1, N.cantouch || !N.hasw3ctouch && !N.hasmstouch ? !N.cantouch || N.isios || N.isandroid || !N.iswebkit && !N.ismozilla || (this.istouchcapable = !0) : this.istouchcapable = !0, k.enablemouselockapi || (N.hasmousecapture = !1, N.haspointerlock = !1), this.debounced = function (t, e, i) {
            T && (T.delaylist[t] || !1 || (T.delaylist[t] = {
                h: h(function () {
                    T.delaylist[t].fn.call(T), T.delaylist[t] = !1
                }, i)
            }, e.call(T)), T.delaylist[t].fn = e)
        }, this.synched = function (t, e) {
            T.synclist[t] ? T.synclist[t] = e : (T.synclist[t] = e, h(function () {
                T && (T.synclist[t] && T.synclist[t].call(T), T.synclist[t] = null)
            }))
        }, this.unsynched = function (t) {
            T.synclist[t] && (T.synclist[t] = !1)
        }, this.css = function (t, e) {
            for (var i in e)T.saved.css.push([t, i, t.css(i)]), t.css(i, e[i])
        }, this.scrollTop = function (t) {
            return void 0 === t ? T.getScrollTop() : T.setScrollTop(t)
        }, this.scrollLeft = function (t) {
            return void 0 === t ? T.getScrollLeft() : T.setScrollLeft(t)
        };
        var $ = function (t, e, i, n, o, s, r) {
            this.st = t, this.ed = e, this.spd = i, this.p1 = n || 0, this.p2 = o || 1, this.p3 = s || 0, this.p4 = r || 1, this.ts = m(), this.df = e - t
        };
        if ($.prototype = {
                B2: function (t) {
                    return 3 * (1 - t) * (1 - t) * t
                    ...
                    var t = (m() - this.ts) / this.spd, e = this.B2(t) + this.B3(t) + this.B4(t);
            ...
            this.doc.translate = {
                ...
                tx: "0px",
                ty: "0px"
            }, N.hastranslate3d && N.isios && this.doc.css("-webkit-backface-visibility", "hidden"), this.getScrollTop = function (t) {
                if (!t) {
                    var e = v();
            ...
            N.hastranslate3d && k.enabletranslate3d ? (this.setScrollTop = function (t, e) {
                T.doc.translate.y = t, T.doc.translate.ty = -1 * t + "px", T.doc.css(N.trstyle, "translate3d(" + T.doc.translate.tx + "," + T.doc.translate.ty + ",0)"), e || T.notifyScrollEvent(T.win[0])
            }, this.setScrollLeft = function (t, e) {
                T.doc.translate.x = t, T.doc.translate.tx = t * L + "px", T.doc.css(N.trstyle, "translate3d(" + T.doc.translate.tx + "," + T.doc.translate.ty + ",0)"), e || T.notifyScrollEvent(T.win[0])
            }) : (this.setScrollTop = function (t, e) {
                T.doc.translate.y = t, T.doc.translate.ty = -1 * t + "px", T.doc.css(N.trstyle, "translate(" + T.doc.translate.tx + "," + T.doc.translate.ty + ")"), e || T.notifyScrollEvent(T.win[0])
            }, this.setScrollLeft = function (t, e) {
                T.doc.translate.x = t, T.doc.translate.tx = t * L + "px", T.doc.css(N.trstyle, "translate(" + T.doc.translate.tx + "," + T.doc.translate.ty + ")"), e || T.notifyScrollEvent(T.win[0])
            })
        } else this.getScrollTop = function () {
            return T.docscroll.scrollTop()
        }, this.setScrollTop = function (t) {
            T.docscroll.scrollTop(t)
        }, this.getScrollLeft = function () {
            return T.hasreversehr ? T.detected.ismozilla ? T.page.maxw - Math.abs(T.docscroll.scrollLeft()) : T.page.maxw - T.docscroll.scrollLeft() : T.docscroll.scrollLeft()
        }, this.setScrollLeft = function (t) {
            return setTimeout(function () {
                if (T)return T.hasreversehr && (t = T.detected.ismozilla ? -(T.page.maxw - t) : T.page.maxw - t), T.docscroll.scrollLeft(t)
            }, 1)
        };
        ...
        this.getDocumentScrollOffset = function () {
            ...
            if (T.isfixed) {
                var t = T.win.offset(), e = T.getDocumentScrollOffset();
                return t.top -= e.top, t.left -= e.left, t
            }
            var i = T.win.offset();
            if (!T.viewport)return i;
            var n = T.viewport.offset();
            return {top: i.top - n.top, left: i.left - n.left}
        }, this.updateScrollBar = function (t) {
            var e, i;
            if (T.ishwscroll)T.rail.css({height: T.win.innerHeight() - (k.railpadding.top + k.railpadding.bottom)}), T.railh && T.railh.css({width: T.win.innerWidth() - (k.railpadding.left + k.railpadding.right)}); else {
                var n = T.getOffset();
                if (e = {
                        top: n.top,
                        left: n.left - (k.railpadding.left + k.railpadding.right)
                    }, e.top += _(T.win, "border-top-width", !0), e.left += T.rail.align ? T.win.outerWidth() - _(T.win, "border-right-width") - T.rail.width : _(T.win, "border-left-width"), (i = k.railoffset) && (i.top && (e.top += i.top), i.left && (e.left += i.left)), T.railslocked || T.rail.css({
                        top: e.top,
                        left: e.left,
                        height: (t ? t.h : T.win.innerHeight()) - (k.railpadding.top + k.railpadding.bottom)
                    }), T.zoom && T.zoom.css({
                        top: e.top + 1,
                        left: 1 == T.rail.align ? e.left - 20 : e.left + T.rail.width + 4
                    }), T.railh && !T.railslocked) {
                    e = {
                        top: n.top,
                        left: n.left
                    }, (i = k.railhoffset) && (i.top && (e.top += i.top), i.left && (e.left += i.left));
                    var o = T.railh.align ? e.top + _(T.win, "border-top-width", !0) + T.win.innerHeight() - T.railh.height : e.top + _(T.win, "border-top-width", !0), s = e.left + _(T.win, "border-left-width");
                    T.railh.css({top: o - (k.railpadding.top + k.railpadding.bottom), left: s, width: T.railh.width})
                }
            }
        }, this.doRailClick = function (t, e, i) {
            var n, o, s, r;
            T.railslocked || (T.cancelEvent(t), "pageY" in t || (t.pageX = t.clientX + a.documentElement.scrollLeft, t.pageY = t.clientY + a.documentElement.scrollTop), e ? (n = i ? T.doScrollLeft : T.doScrollTop, s = i ? (t.pageX - T.railh.offset().left - T.cursorwidth / 2) * T.scrollratio.x : (t.pageY - T.rail.offset().top - T.cursorheight / 2) * T.scrollratio.y, T.unsynched("relativexy"), n(0 | s)) : (n = i ? T.doScrollLeftBy : T.doScrollBy, s = i ? T.scroll.x : T.scroll.y, r = i ? t.pageX - T.railh.offset().left : t.pageY - T.rail.offset().top, o = i ? T.view.w : T.view.h, n(s >= r ? o : -o)))
        }, T.newscrolly = T.newscrollx = 0, T.hasanimationframe = "requestAnimationFrame" in l, T.hascancelanimationframe = "cancelAnimationFrame" in l, T.hasborderbox = !1, this.init = function () {
            if (T.saved.css = [], N.isoperamini)return !0;
            if (N.isandroid && !("hidden" in a))return !0;
            k.emulatetouch = k.emulatetouch || k.touchbehavior, T.hasborderbox = l.getComputedStyle && "border-box" === l.getComputedStyle(a.body)["box-sizing"];
            var t = {"overflow-y": "hidden"};
            if ((N.isie11 || N.isie10) && (t["-ms-overflow-style"] = "none"), T.ishwscroll && (this.doc.css(N.transitionstyle, N.prefixstyle + "transform 0ms ease-out"), N.transitionend && T.bind(T.doc, N.transitionend, T.onScrollTransitionEnd, !1)), T.zindex = "auto", T.ispage || "auto" != k.zindex ? T.zindex = k.zindex : T.zindex = w() || "auto", !T.ispage && "auto" != T.zindex && T.zindex > s && (s = T.zindex), T.isie && 0 === T.zindex && "auto" == k.zindex && (T.zindex = "auto"), !T.ispage || !N.isieold) {
                var o = T.docscroll;
                T.ispage && (o = T.haswrapper ? T.win : T.doc), T.css(o, t), T.ispage && (N.isie11 || N.isie) && T.css(r("html"), t), !N.isios || T.ispage || T.haswrapper || T.css(E, {"-webkit-overflow-scrolling": "touch"});
                ...
                }), u.addClass("nicescroll-cursors"), T.cursor = u;
                var h = r(a.createElement("div"));
                h.attr("id", T.id), h.addClass("nicescroll-rails nicescroll-rails-vr");
                var d, p, m = ["left", "right", "top", "bottom"];
                for (var g in m)p = m[g], (d = k.railpadding[p] || 0) && h.css("padding-" + p, d + "px");
                h.append(u), h.width = Math.max(parseFloat(k.cursorwidth), u.outerWidth()), h.css({
                    width: h.width + "px",
                    zIndex: T.zindex,
                    background: k.background,
                    cursor: "default"
                }), h.visibility = !0, h.scrollable = !0, h.align = "left" == k.railalign ? 0 : 1, T.rail = h, T.rail.drag = !1;
                var v = !1;
                !k.boxzoom || T.ispage || N.isieold || (v = a.createElement("div"), T.bind(v, "click", T.doZoom), T.bind(v, "mouseenter", function () {
                    T.zoom.css("opacity", k.cursoropacitymax)
                }), T.bind(v, "mouseleave", function () {
                    T.zoom.css("opacity", k.cursoropacitymin)
                }), T.zoom = r(v), T.zoom.css({
                    cursor: "pointer",
                    zIndex: T.zindex,
                ...
                }), k.dblclickzoom && T.bind(T.win, "dblclick", T.doZoom), N.cantouch && k.gesturezoom && (T.ongesturezoom = function (t) {
                    return t.scale > 1.5 && T.doZoomIn(t), t.scale < .8 && T.doZoomOut(t), T.cancelEvent(t)
                }, T.bind(T.win, "gestureend", T.ongesturezoom))), T.railh = !1;
                var y;
                if (k.horizrailenabled && (T.css(o, {overflowX: "hidden"}), (u = r(a.createElement("div"))).css({
                        position: "absolute",
                        top: 0,
                        ...
                        "-moz-border-radius": k.cursorborderradius,
                        "border-radius": k.cursorborderradius
                    }), N.isieold && u.css("overflow", "hidden"), u.addClass("nicescroll-cursors"), T.cursorh = u, (y = r(a.createElement("div"))).attr("id", T.id + "-hr"), y.addClass("nicescroll-rails nicescroll-rails-hr"), y.height = Math.max(parseFloat(k.cursorwidth), u.outerHeight()), y.css({
                        height: y.height + "px",
                        zIndex: T.zindex,
                        background: k.background
                    }), y.append(u), y.visibility = !0, y.scrollable = !0, y.align = "top" == k.railvalign ? 0 : 1, T.railh = y, T.railh.drag = !1), T.ispage)h.css({
                    position: "fixed",
                    top: 0,
                    height: "100%"
                }), h.css(h.align ? {right: 0} : {left: 0}), T.body.append(h), T.railh && (y.css({
                    position: "fixed",
                    left: 0,
                    width: "100%"
                }), y.css(y.align ? {bottom: 0} : {top: 0}), T.body.append(y)); else {
                    if (T.ishwscroll) {
                        "static" == T.win.css("position") && T.css(T.win, {position: "relative"});
                        var _ = "HTML" == T.win[0].nodeName ? T.body : T.win;
                        r(_).scrollTop(0).scrollLeft(0), T.zoom && (T.zoom.css({
                            position: "absolute",
                            top: 1,
                            right: 0,
                            "margin-right": h.width + 4
                        }), _.append(T.zoom)), h.css({
                            position: "absolute",
                            top: 0
                        }), h.css(h.align ? {right: 0} : {left: 0}), _.append(h), y && (y.css({
                            position: "absolute",
                            left: 0,
                            bottom: 0
                        }), y.css(y.align ? {bottom: 0} : {top: 0}), _.append(y))
                    } else {
                        T.isfixed = "fixed" == T.win.css("position");
                        var x = T.isfixed ? "fixed" : "absolute";
                        T.isfixed || (T.viewport = T.getViewport(T.win[0])), T.viewport && (T.body = T.viewport, /fixed|absolute/.test(T.viewport.css("position")) || T.css(T.viewport, {position: "relative"})), h.css({position: x}), T.zoom && T.zoom.css({position: x}), T.updateScrollBar(), T.body.append(h), T.zoom && T.body.append(T.zoom), T.railh && (y.css({position: x}), T.body.append(y))
                    }
                    N.isios && T.css(T.win, {
                        "-webkit-tap-highlight-color": "rgba(0,0,0,0)",
                        "-webkit-touch-callout": "none"
                    }), k.disableoutline && (N.isie && T.win.attr("hideFocus", "true"), N.iswebkit && T.win.css("outline", "none"))
                }
                if (!1 === k.autohidemode ? (T.autohidedom = !1, T.rail.css({opacity: k.cursoropacitymax}), T.railh && T.railh.css({opacity: k.cursoropacitymax})) : !0 === k.autohidemode || "leave" === k.autohidemode ? (T.autohidedom = r().add(T.rail), N.isie8 && (T.autohidedom = T.autohidedom.add(T.cursor)), T.railh && (T.autohidedom = T.autohidedom.add(T.railh)), T.railh && N.isie8 && (T.autohidedom = T.autohidedom.add(T.cursorh))) : "scroll" == k.autohidemode ? (T.autohidedom = r().add(T.rail), T.railh && (T.autohidedom = T.autohidedom.add(T.railh))) : "cursor" == k.autohidemode ? (T.autohidedom = r().add(T.cursor), T.railh && (T.autohidedom = T.autohidedom.add(T.cursorh))) : "hidden" == k.autohidemode && (T.autohidedom = !1, T.hide(), T.railslocked = !1), N.cantouch || T.istouchcapable || k.emulatetouch || N.hasmstouch) {
                    T.scrollmom = new b(T), T.ontouchstart = function (t) {
                        if (T.locked)return !1;
                        if (t.pointerType && ("mouse" === t.pointerType || t.pointerType === t.MSPOINTER_TYPE_MOUSE))return !1;
                        if (T.hasmoving = !1, T.scrollmom.timer && (T.triggerScrollEnd(), T.scrollmom.stop()), !T.railslocked) {
                            var e = T.getTarget(t);
                            if (e && /INPUT/i.test(e.nodeName) && /range/i.test(e.type))return T.stopPropagation(t);
                            var i = "mousedown" === t.type;
                            if (!("clientX" in t) && "changedTouches" in t && (t.clientX = t.changedTouches[0].clientX, t.clientY = t.changedTouches[0].clientY), T.forcescreen) {
                                var n = t;
                            ...
                            if (T.rail.drag = {
                                    ...
                                    dl: !1,
                                    tg: e
                                }, T.ispage || !k.directionlockdeadzone)T.rail.drag.dl = "f"; else {
                                var o = {
                                    w: c.width(),
                                    h: c.height()
                                }, s = T.getContentSize(), a = s.h - o.h, l = s.w - o.w;
                                T.rail.scrollable && !T.railh.scrollable ? T.rail.drag.ck = a > 0 && "v" : !T.rail.scrollable && T.railh.scrollable ? T.rail.drag.ck = l > 0 && "h" : T.rail.drag.ck = !1
                            }
                            if (k.emulatetouch && T.isiframe && N.isie) {
                                var u = T.win.position();
                                T.rail.drag.x += u.left, T.rail.drag.y += u.top
                            }
                            if (T.hasmoving = !1, T.lastmouseup = !1, T.scrollmom.reset(t.clientX, t.clientY), e && i) {
                                if (!/INPUT|SELECT|BUTTON|TEXTAREA/i.test(e.nodeName))return N.hasmousecapture && e.setCapture(), k.emulatetouch ? (e.onclick && !e._onclick && (e._onclick = e.onclick, e.onclick = function (t) {
                                    if (T.hasmoving)return !1;
                                    e._onclick.call(this, t)
                                }), T.cancelEvent(t)) : T.stopPropagation(t);
                                /SUBMIT|CANCEL|BUTTON/i.test(r(e).attr("type")) && (T.preventclick = {tg: e, click: !1})
                            }
                        }
                        ...
                        if (2 == T.rail.drag.pt) {
                            ...
                            if (T.hasmoving && (T.scrollmom.doMomentum(), T.lastmouseup = !0, T.hideCursor(), N.hasmousecapture && a.releaseCapture(), e))return T.cancelEvent(t)
                        } else if (1 == T.rail.drag.pt)return T.onmouseup(t)
                    };
                    var C = k.emulatetouch && T.isiframe && !N.hasmousecapture, S = .3 * k.directionlockdeadzone | 0;
                    T.ontouchmove = function (t, e) {
                        if (!T.rail.drag)return !0;
                        ...
                        if (2 == T.rail.drag.pt) {
                            ...
                            var i, n;
                            if (n = i = 0, C && !e) {
                                var o = T.win.position();
                                n = -o.left, i = -o.top
                            }
                            var s = t.clientY + i, r = s - T.rail.drag.y, l = t.clientX + n, c = l - T.rail.drag.x, u = T.rail.drag.st - r;
                            if (T.ishwscroll && k.bouncescroll)u < 0 ? u = Math.round(u / 2) : u > T.page.maxh && (u = T.page.maxh + Math.round((u - T.page.maxh) / 2)); else if (u < 0 ? (u = 0, s = 0) : u > T.page.maxh && (u = T.page.maxh, s = 0), 0 === s && !T.hasmoving)return T.ispage || (T.rail.drag = !1), !0;
                            var h = T.getScrollLeft();
                            if (T.railh && T.railh.scrollable && (h = T.isrtlmode ? c - T.rail.drag.sl : T.rail.drag.sl - c, T.ishwscroll && k.bouncescroll ? h < 0 ? h = Math.round(h / 2) : h > T.page.maxw && (h = T.page.maxw + Math.round((h - T.page.maxw) / 2)) : (h < 0 && (h = 0, l = 0), h > T.page.maxw && (h = T.page.maxw, l = 0))), !T.hasmoving) {
                                if (T.rail.drag.y === t.clientY && T.rail.drag.x === t.clientX)return T.cancelEvent(t);
                                var d = Math.abs(r), p = Math.abs(c), f = k.directionlockdeadzone;
                                if (T.rail.drag.ck ? "v" == T.rail.drag.ck ? p > f && d <= S ? T.rail.drag = !1 : d > f && (T.rail.drag.dl = "v") : "h" == T.rail.drag.ck && (d > f && p <= S ? T.rail.drag = !1 : p > f && (T.rail.drag.dl = "h")) : d > f && p > f ? T.rail.drag.dl = "f" : d > f ? T.rail.drag.dl = p > S ? "f" : "v" : p > f && (T.rail.drag.dl = d > S ? "f" : "h"), !T.rail.drag.dl)return T.cancelEvent(t);
                                T.triggerScrollStart(t.clientX, t.clientY, 0, 0, 0), T.hasmoving = !0
                            }
                            return T.preventclick && !T.preventclick.click && (T.preventclick.click = T.preventclick.tg.onclick || !1, T.preventclick.tg.onclick = T.onpreventclick), T.rail.drag.dl && ("v" == T.rail.drag.dl ? h = T.rail.drag.sl : "h" == T.rail.drag.dl && (u = T.rail.drag.st)), T.synched("touchmove", function () {
                                T.rail.drag && 2 == T.rail.drag.pt && (T.prepareTransition && T.resetTransition(), T.rail.scrollable && T.setScrollTop(u), T.scrollmom.update(l, s), T.railh && T.railh.scrollable ? (T.setScrollLeft(h), T.showCursor(u, h)) : T.showCursor(u), N.isie10 && a.selection.clear())
                            }), T.cancelEvent(t)
                        }
                        return 1 == T.rail.drag.pt ? T.onmousemove(t) : void 0
                    }, T.ontouchstartCursor = function (t, e) {
                        if (!T.rail.drag || 3 == T.rail.drag.pt) {
                            if (T.locked)return T.cancelEvent(t);
                            ...
                            var i = T.getTarget(t);
                            return !T.ispage && N.hasmousecapture && i.setCapture(), T.isiframe && !N.hasmousecapture && (T.saved.csspointerevents = T.doc.css("pointer-events"), T.css(T.doc, {"pointer-events": "none"})), T.cancelEvent(t)
                        }
                    }, T.ontouchendCursor = function (t) {
                        if (T.rail.drag) {
                            if (N.hasmousecapture && a.releaseCapture(), T.isiframe && !N.hasmousecapture && T.doc.css("pointer-events", T.saved.csspointerevents), 3 != T.rail.drag.pt)return;
                            return T.rail.drag = !1, T.cancelEvent(t)
                        }
                    }, T.ontouchmoveCursor = function (t) {
                        if (T.rail.drag) {
                            if (3 != T.rail.drag.pt)return;
                            if (T.cursorfreezed = !0, T.rail.drag.hr) {
                                T.scroll.x = T.rail.drag.sx + (t.touches[0].clientX - T.rail.drag.x), T.scroll.x < 0 && (T.scroll.x = 0);
                                var e = T.scrollvaluemaxw;
                                T.scroll.x > e && (T.scroll.x = e)
                            } else {
                                T.scroll.y = T.rail.drag.sy + (t.touches[0].clientY - T.rail.drag.y), T.scroll.y < 0 && (T.scroll.y = 0);
                                var i = T.scrollvaluemax;
                                T.scroll.y > i && (T.scroll.y = i)
                            }
                            return T.synched("touchmove", function () {
                                T.rail.drag && 3 == T.rail.drag.pt && (T.showCursor(), T.rail.drag.hr ? T.doScrollLeft(Math.round(T.scroll.x * T.scrollratio.x), k.cursordragspeed) : T.doScrollTop(Math.round(T.scroll.y * T.scrollratio.y), k.cursordragspeed))
                            }), T.cancelEvent(t)
                        }
                    }
                }
                if (T.onmousedown = function (t, e) {
                        if (!T.rail.drag || 1 == T.rail.drag.pt) {
                            if (T.railslocked)return T.cancelEvent(t);
                            T.cancelScroll(), T.rail.drag = {
                                x: t.clientX,
                                y: t.clientY,
                                sx: T.scroll.x,
                            ...
                            var i = T.getTarget(t);
                            return N.hasmousecapture && i.setCapture(), T.isiframe && !N.hasmousecapture && (T.saved.csspointerevents = T.doc.css("pointer-events"), T.css(T.doc, {"pointer-events": "none"})), T.hasmoving = !1, T.cancelEvent(t)
                        }
                    }, T.onmouseup = function (t) {
                        if (T.rail.drag)return 1 != T.rail.drag.pt || (N.hasmousecapture && a.releaseCapture(), T.isiframe && !N.hasmousecapture && T.doc.css("pointer-events", T.saved.csspointerevents), T.rail.drag = !1, T.cursorfreezed = !1, T.hasmoving && T.triggerScrollEnd(), T.cancelEvent(t))
                    }, T.onmousemove = function (t) {
                        if (T.rail.drag) {
                            if (1 !== T.rail.drag.pt)return;
                            if (N.ischrome && 0 === t.which)return T.onmouseup(t);
                            if (T.cursorfreezed = !0, T.hasmoving || T.triggerScrollStart(t.clientX, t.clientY, 0, 0, 0), T.hasmoving = !0, T.rail.drag.hr) {
                                T.scroll.x = T.rail.drag.sx + (t.clientX - T.rail.drag.x), T.scroll.x < 0 && (T.scroll.x = 0);
                                var e = T.scrollvaluemaxw;
                                T.scroll.x > e && (T.scroll.x = e)
                            } else {
                                T.scroll.y = T.rail.drag.sy + (t.clientY - T.rail.drag.y), T.scroll.y < 0 && (T.scroll.y = 0);
                                var i = T.scrollvaluemax;
                                T.scroll.y > i && (T.scroll.y = i)
                            }
                        ...
                        T.checkarea = 0
                    }, N.cantouch || k.emulatetouch)T.onpreventclick = function (t) {
                    if (T.preventclick)return T.preventclick.tg.onclick = T.preventclick.click, T.preventclick = !1, T.cancelEvent(t)
                }, T.onclick = !N.isios && function (t) {
                        return !T.lastmouseup || (T.lastmouseup = !1, T.cancelEvent(t))
                    }, k.grabcursorenabled && N.cursorgrabvalue && (T.css(T.ispage ? T.doc : T.win, {cursor: N.cursorgrabvalue}), T.css(T.rail, {cursor: N.cursorgrabvalue})); else {
                    var z = function (t) {
                        if (T.selectiondrag) {
                            if (t) {
                                var e = T.win.outerHeight(), i = t.pageY - T.selectiondrag.top;
                                i > 0 && i < e && (i = 0), i >= e && (i -= e), T.selectiondrag.df = i
                            }
                            if (0 !== T.selectiondrag.df) {
                                var n = -2 * T.selectiondrag.df / 6 | 0;
                                T.doScrollBy(n), T.debounced("doselectionscroll", function () {
                                    z()
                                }, 50)
                            }
                        }
                    };
                    T.hasTextSelected = "getSelection" in a ? function () {
                        return a.getSelection().rangeCount > 0
                    } : "selection" in a ? function () {
                        return "None" != a.selection.type
                    } : function () {
                        return !1
                    }, T.onselectionstart = function (t) {
                        T.ispage || (T.selectiondrag = T.win.offset())
                    }, T.onselectionend = function (t) {
                        T.selectiondrag = !1
                    }, T.onselectiondrag = function (t) {
                        T.selectiondrag && T.hasTextSelected() && T.debounced("selectionscroll", function () {
                            z(t)
                        }, 250)
                    }
                }
                if (N.hasw3ctouch ? (T.css(T.ispage ? r("html") : T.win, {"touch-action": "none"}), T.css(T.rail, {"touch-action": "none"}), T.css(T.cursor, {"touch-action": "none"}), T.bind(T.win, "pointerdown", T.ontouchstart), T.bind(a, "pointerup", T.ontouchend), T.delegate(a, "pointermove", T.ontouchmove)) : N.hasmstouch ? (T.css(T.ispage ? r("html") : T.win, {"-ms-touch-action": "none"}), T.css(T.rail, {"-ms-touch-action": "none"}), T.css(T.cursor, {"-ms-touch-action": "none"}), T.bind(T.win, "MSPointerDown", T.ontouchstart), T.bind(a, "MSPointerUp", T.ontouchend), T.delegate(a, "MSPointerMove", T.ontouchmove), T.bind(T.cursor, "MSGestureHold", function (t) {
                        t.preventDefault()
                    }), T.bind(T.cursor, "contextmenu", function (t) {
                        t.preventDefault()
                    })) : N.cantouch && (T.bind(T.win, "touchstart", T.ontouchstart, !1, !0), T.bind(a, "touchend", T.ontouchend, !1, !0), T.bind(a, "touchcancel", T.ontouchend, !1, !0), T.delegate(a, "touchmove", T.ontouchmove, !1, !0)), k.emulatetouch && (T.bind(T.win, "mousedown", T.ontouchstart, !1, !0), T.bind(a, "mouseup", T.ontouchend, !1, !0), T.bind(a, "mousemove", T.ontouchmove, !1, !0)), (k.cursordragontouch || !N.cantouch && !k.emulatetouch) && (T.rail.css({cursor: "default"}), T.railh && T.railh.css({cursor: "default"}), T.jqbind(T.rail, "mouseenter", function () {
                        if (!T.ispage && !T.win.is(":visible"))return !1;
                        T.canshowonmouseevent && T.showCursor(), T.rail.active = !0
                    }), T.jqbind(T.rail, "mouseleave", function () {
                        T.rail.active = !1, T.rail.drag || T.hideCursor()
                    }), k.sensitiverail && (T.bind(T.rail, "click", function (t) {
                        T.doRailClick(t, !1, !1)
                    }), T.bind(T.rail, "dblclick", function (t) {
                        T.doRailClick(t, !0, !1)
                    }), T.bind(T.cursor, "click", function (t) {
                        T.cancelEvent(t)
                    }), T.bind(T.cursor, "dblclick", function (t) {
                        T.cancelEvent(t)
                        ...
                        T.rail.active = !1, T.rail.drag || T.hideCursor()
                    }), k.sensitiverail && (T.bind(T.railh, "click", function (t) {
                        T.doRailClick(t, !1, !0)
                    }), T.bind(T.railh, "dblclick", function (t) {
                        T.doRailClick(t, !0, !0)
                    }), T.bind(T.cursorh, "click", function (t) {
                        T.cancelEvent(t)
                    }), T.bind(T.cursorh, "dblclick", function (t) {
                        T.cancelEvent(t)
                    })))), k.cursordragontouch && (this.istouchcapable || N.cantouch) && (T.bind(T.cursor, "touchstart", T.ontouchstartCursor), T.bind(T.cursor, "touchmove", T.ontouchmoveCursor), T.bind(T.cursor, "touchend", T.ontouchendCursor), T.cursorh && T.bind(T.cursorh, "touchstart", function (t) {
                        T.ontouchstartCursor(t, !0)
                    }), T.cursorh && T.bind(T.cursorh, "touchmove", T.ontouchmoveCursor), T.cursorh && T.bind(T.cursorh, "touchend", T.ontouchendCursor)), k.emulatetouch || N.isandroid || N.isios ? (T.bind(N.hasmousecapture ? T.win : a, "mouseup", T.ontouchend), T.onclick && T.bind(a, "click", T.onclick), k.cursordragontouch ? (T.bind(T.cursor, "mousedown", T.onmousedown), T.bind(T.cursor, "mouseup", T.onmouseup), T.cursorh && T.bind(T.cursorh, "mousedown", function (t) {
                        T.onmousedown(t, !0)
                    }), T.cursorh && T.bind(T.cursorh, "mouseup", T.onmouseup)) : (T.bind(T.rail, "mousedown", function (t) {
                        t.preventDefault()
                    }), T.railh && T.bind(T.railh, "mousedown", function (t) {
                        t.preventDefault()
                    }))) : (T.bind(N.hasmousecapture ? T.win : a, "mouseup", T.onmouseup), T.bind(a, "mousemove", T.onmousemove), T.onclick && T.bind(a, "click", T.onclick), T.bind(T.cursor, "mousedown", T.onmousedown), T.bind(T.cursor, "mouseup", T.onmouseup), T.railh && (T.bind(T.cursorh, "mousedown", function (t) {
                        T.onmousedown(t, !0)
                    }), T.bind(T.cursorh, "mouseup", T.onmouseup)), !T.ispage && k.enablescrollonselection && (T.bind(T.win[0], "mousedown", T.onselectionstart), T.bind(a, "mouseup", T.onselectionend), T.bind(T.cursor, "mouseup", T.onselectionend), T.cursorh && T.bind(T.cursorh, "mouseup", T.onselectionend), T.bind(a, "mousemove", T.onselectiondrag)), T.zoom && (T.jqbind(T.zoom, "mouseenter", function () {
                        T.canshowonmouseevent && T.showCursor(), T.rail.active = !0
                    }), T.jqbind(T.zoom, "mouseleave", function () {
                        T.rail.active = !1, T.rail.drag || T.hideCursor()
                    }))), k.enablemousewheel && (T.isiframe || T.mousewheel(N.isie && T.ispage ? a : T.win, T.onmousewheel), T.mousewheel(T.rail, T.onmousewheel), T.railh && T.mousewheel(T.railh, T.onmousewheelhr)), T.ispage || N.cantouch || /HTML|^BODY/.test(T.win[0].nodeName) || (T.win.attr("tabindex") || T.win.attr({tabindex: ++n}), T.bind(T.win, "focus", function (t) {
                        e = T.getTarget(t).id || T.getTarget(t) || !1, T.hasfocus = !0, T.canshowonmouseevent && T.noticeCursor()
                    }), T.bind(T.win, "blur", function (t) {
                        e = !1, T.hasfocus = !1
                    }), T.bind(T.win, "mouseenter", function (t) {
                        i = T.getTarget(t).id || T.getTarget(t) || !1, T.hasmousefocus = !0, T.canshowonmouseevent && T.noticeCursor()
                    }), T.bind(T.win, "mouseleave", function (t) {
                        ...
                        if (T.hasfocus || T.hasmousefocus && !e || T.ispage && !e && !i) {
                            var o = t.keyCode;
                            if (T.railslocked && 27 != o)return T.cancelEvent(t);
                            var s = t.ctrlKey || !1, a = t.shiftKey || !1, c = !1;
                            switch (o) {
                                case 38:
                                case 63233:
                                    T.doScrollBy(72), c = !0;
                                ...
                                case 63275:
                                    ...
                                    break;
                                case 32:
                                    k.spacebarenabled && (a ? T.doScrollBy(T.view.h) : T.doScrollBy(-T.view.h), c = !0);
                                    break;
                                case 27:
                    ...
                    }, k.enablekeyboard && T.bind(a, N.isopera && !N.isopera12 ? "keypress" : "keydown", T.onkeypress), T.bind(a, "keydown", function (t) {
                        (t.ctrlKey || !1) && (T.wheelprevented = !0)
                    }), T.bind(a, "keyup", function (t) {
                        t.ctrlKey || !1 || (T.wheelprevented = !1)
                    }), T.bind(l, "blur", function (t) {
                        T.wheelprevented = !1
                    }), T.bind(l, "resize", T.onscreenresize), T.bind(l, "orientationchange", T.onscreenresize), T.bind(l, "load", T.lazyResize), N.ischrome && !T.ispage && !T.haswrapper) {
                    var D = T.win.attr("style"), I = parseFloat(T.win.css("width")) + 1;
                    T.win.css("width", I), T.synched("chromefix", function () {
                        T.win.attr("style", D)
                    })
                }
                if (T.onAttributeChange = function (t) {
                        T.lazyResize(T.isieold ? 250 : 30)
                    }, k.enableobserver && (T.isie11 || !1 === f || (T.observerbody = new f(function (t) {
                        if (t.forEach(function (t) {
                                if ("attributes" == t.type)return E.hasClass("modal-open") && E.hasClass("modal-dialog") && !r.contains(r(".modal-dialog")[0], T.doc[0]) ? T.hide() : T.show()
                            }), T.me.clientWidth != T.page.width || T.me.clientHeight != T.page.height)return T.lazyResize(30)
                    }), T.observerbody.observe(a.body, {
                        childList: !0,
                        subtree: !0,
                        characterData: !1,
                        attributes: !0,
                    ...
                    var $ = T.win[0];
                    !1 !== f ? (T.observer = new f(function (t) {
                        t.forEach(T.onAttributeChange)
                    }), T.observer.observe($, {
                        childList: !0,
                        characterData: !1,
                        attributes: !0,
                        subtree: !1
                    }), T.observerremover = new f(function (t) {
                        t.forEach(function (t) {
                            if (t.removedNodes.length > 0)for (var e in t.removedNodes)if (T && t.removedNodes[e] === $)return T.remove()
                        })
                    }), T.observerremover.observe($.parentNode, {
                        childList: !0,
                        characterData: !1,
                        attributes: !1,
                        subtree: !1
                    })) : (T.bind($, N.isie && !N.isie9 ? "propertychange" : "DOMAttrModified", T.onAttributeChange), N.isie9 && $.attachEvent("onpropertychange", T.onAttributeChange), T.bind($, "DOMNodeRemoved", function (t) {
                        t.target === $ && T.remove()
                    }))
                }
                !T.ispage && k.boxzoom && T.bind(l, "resize", T.resizeZoom), T.istextarea && (T.bind(T.win, "keydown", T.lazyResize), T.bind(T.win, "mouseup", T.lazyResize)), T.lazyResize(30)
            }
            if ("IFRAME" == this.doc[0].nodeName) {
                var L = function () {
                    ...
                    if (T.iframexd)return "console" in l && console.log("NiceScroll error: policy restriced iframe"), !0;
                    if (T.forcescreen = !0, T.isiframe && (T.iframe = {
                        ...
                        }, T.docscroll = r(T.iframe.body)), !N.isios && k.iframeautoresize && !T.isiframe) {
                        T.win.scrollTop(0), T.doc.height("");
                        var i = Math.max(e.getElementsByTagName("html")[0].scrollHeight, e.body.scrollHeight);
                        T.doc.height(i)
                    }
                    T.lazyResize(30), T.css(r(T.iframe.body), t), N.isios && T.haswrapper && T.css(r(e.body), {"-webkit-transform": "translate3d(0,0,0)"}), "contentWindow" in this ? T.bind(this.contentWindow, "scroll", T.onscroll) : T.bind(e, "scroll", T.onscroll), k.enablemousewheel && T.mousewheel(e, T.onmousewheel), k.enablekeyboard && T.bind(e, N.isopera ? "keypress" : "keydown", T.onkeypress), N.cantouch ? (T.bind(e, "touchstart", T.ontouchstart), T.bind(e, "touchmove", T.ontouchmove)) : k.emulatetouch && (T.bind(e, "mousedown", T.ontouchstart), T.bind(e, "mousemove", function (t) {
                        return T.ontouchmove(t, !0)
                    }), k.grabcursorenabled && N.cursorgrabvalue && T.css(r(e.body), {cursor: N.cursorgrabvalue})), T.bind(e, "mouseup", T.ontouchend), T.zoom && (k.dblclickzoom && T.bind(e, "dblclick", T.doZoom), T.ongesturezoom && T.bind(e, "gestureend", T.ongesturezoom))
                };
                this.doc[0].readyState && "complete" === this.doc[0].readyState && setTimeout(function () {
                    L.call(T.doc[0], !1)
                }, 500), T.bind(this.doc, "load", L)
            }
        }, this.showCursor = function (t, e) {
            if (T.cursortimeout && (clearTimeout(T.cursortimeout), T.cursortimeout = 0), T.rail) {
                if (T.autohidedom && (T.autohidedom.stop().css({opacity: k.cursoropacitymax}), T.cursoractive = !0), T.rail.drag && 1 == T.rail.drag.pt || (void 0 !== t && !1 !== t && (T.scroll.y = t / T.scrollratio.y | 0), void 0 !== e && (T.scroll.x = e / T.scrollratio.x | 0)), T.cursor.css({
                ...
                T.zoom && T.zoom.stop().css({opacity: k.cursoropacitymax})
            }
        }, this.hideCursor = function (t) {
            T.cursortimeout || T.rail && T.autohidedom && (T.hasmousefocus && "leave" === k.autohidemode || (T.cursortimeout = setTimeout(function () {
                T.rail.active && T.showonmouseevent || (T.autohidedom.stop().animate({opacity: k.cursoropacitymin}), T.zoom && T.zoom.stop().animate({opacity: k.cursoropacitymin}), T.cursoractive = !1), T.cursortimeout = 0
            }, t || k.hidecursordelay)))
        }, this.noticeCursor = function (t, e, i) {
            T.showCursor(e, i), T.rail.active || T.hideCursor(t)
        ...
        this.onscreenresize = function (t) {
            ...
            e && T.hideRails(), A = setTimeout(function () {
                T && (e && T.showRails(), T.resize()), A = 0
            }, 120)
        }, this.lazyResize = function (t) {
            return clearTimeout(A), t = isNaN(t) ? 240 : t, A = setTimeout(function () {
                T && T.resize(), A = 0
            }, t), T
        }, this.jqbind = function (t, e, i) {
            T.events.push({e: t, n: e, f: i, q: !0}), r(t).on(e, i)
        }, this.mousewheel = function (t, e, i) {
            var n = "jquery" in t ? t[0] : t;
            if ("onwheel" in a.createElement("div"))T._bind(n, "wheel", e, i || !1); else {
                var o = void 0 !== a.onmousewheel ? "mousewheel" : "DOMMouseScroll";
                x(n, o, e, i || !1), "DOMMouseScroll" == o && x(n, "MozMousePixelScroll", e, i || !1)
            }
        };
        var j = !1;
        if (N.haseventlistener) {
            try {
            ...
            this.cancelBubble = !0
        }, l.constructor.prototype.addEventListener = a.constructor.prototype.addEventListener = Element.prototype.addEventListener = function (t, e, i) {
            this.attachEvent("on" + t, e)
        }, l.constructor.prototype.removeEventListener = a.constructor.prototype.removeEventListener = Element.prototype.removeEventListener = function (t, e, i) {
        ...
        this.delegate = function (t, e, i, n, o) {
            var s = u[e] || !1;
            s || (s = {
                a: [], l: [], f: function (t) {
                    for (var e = s.l, i = !1, n = e.length - 1; n >= 0; n--)if (!1 === (i = e[n].call(t.target, t)))return !1;
                    return i
                }
            }, T.bind(t, e, s.f, n, o), u[e] = s), T.ispage ? (s.a = [T.id].concat(s.a), s.l = [i].concat(s.l)) : (s.a.push(T.id), s.l.push(i))
        }, this.undelegate = function (t, e, i, n, o) {
            var s = u[e] || !1;
            if (s && s.l)for (var r = 0, a = s.l.length; r < a; r++)s.a[r] === T.id && (s.a.splice(r), s.l.splice(r), 0 === s.a.length && (T._unbind(t, e, s.l.f), u[e] = null))
        }, this.bind = function (t, e, i, n, o) {
            var s = "jquery" in t ? t[0] : t;
            T._bind(s, e, i, n || !1, o || !1)
        }, this._bind = function (t, e, i, n, o) {
            T.events.push({e: t, n: e, f: i, b: n, q: !1}), j && o ? t.addEventListener(e, i, {
                passive: !1,
                capture: n
            }) : t.addEventListener(e, i, n || !1)
        }, this._unbind = function (t, e, i, n) {
            u[e] ? T.undelegate(t, e, i, n) : t.removeEventListener(e, i, n)
        }, this.unbindAll = function () {
            for (var t = 0; t < T.events.length; t++) {
                var e = T.events[t];
                e.q ? e.e.unbind(e.n, e.f) : T._unbind(e.e, e.n, e.f, e.b)
            }
            ...
            for (var t in T.delaylist)T.delaylist[t] && d(T.delaylist[t].h);
            ...
            for (var o in T)T[o] = null, delete T[o];
            T = null
        }, this.scrollstart = function (t) {
            return this.onscrollstart = t, T
        }, this.scrollend = function (t) {
            return this.onscrollend = t, T
        }, this.scrollcancel = function (t) {
            return this.onscrollcancel = t, T
        }, this.zoomin = function (t) {
            return this.onzoomin = t, T
        }, this.zoomout = function (t) {
            return this.onzoomout = t, T
        }, this.isScrollable = function (t) {
            var e = t.target ? t.target : t;
            if ("OPTION" == e.nodeName)return !0;
            for (; e && 1 == e.nodeType && e !== this.me[0] && !/^BODY|HTML/.test(e.nodeName);) {
                var i = r(e);
                if (/scroll|auto/.test(i.css("overflowY") || i.css("overflowX") || i.css("overflow") || ""))return e.clientHeight != e.scrollHeight;
            ...
            for (var e = !(!t || !t.parentNode) && t.parentNode; e && 1 == e.nodeType && !/^BODY|HTML/.test(e.nodeName);) {
                ...
                if (/scroll|auto/.test(i.css("overflowY") || i.css("overflowX") || i.css("overflow") || "") && e.clientHeight != e.scrollHeight)return i;
                if (i.getNiceScroll().length > 0)return i;
                e = !!e.parentNode && e.parentNode
            }
            return !1
        }, this.triggerScrollStart = function (t, e, i, n, o) {
            if (T.onscrollstart) {
                var s = {
                    type: "scrollstart",
                    current: {x: t, y: e},
            ...
            if (T.onscrollend) {
                var t = T.getScrollLeft(), e = T.getScrollTop(), i = {
                    type: "scrollend",
                    current: {x: t, y: e},
                    end: {x: t, y: e}
                };
        ...
        var P = 0, R = 0, H = 0, q = 1, F = !1;
        if (this.onmousewheel = function (t) {
                if (T.wheelprevented || T.locked)return !1;
                if (T.railslocked)return T.debounced("checkunlock", T.resize, 250), !1;
                if (T.rail.drag)return T.cancelEvent(t);
                if ("auto" === k.oneaxismousemode && 0 !== t.deltaX && (k.oneaxismousemode = !1), k.oneaxismousemode && 0 === t.deltaX && !T.rail.scrollable)return !T.railh || !T.railh.scrollable || T.onmousewheelhr(t);
                var e = m(), i = !1;
                if (k.preservenativescrolling && T.checkarea + 600 < e && (T.nativescrollingarea = T.isScrollable(t), i = !0), T.checkarea = e, T.nativescrollingarea)return !0;
                var n = S(t, !1, i);
                return n && (T.checkarea = 0), n
            }, this.onmousewheelhr = function (t) {
                if (!T.wheelprevented) {
                    if (T.railslocked || !T.railh.scrollable)return !0;
                    if (T.rail.drag)return T.cancelEvent(t);
                    var e = m(), i = !1;
                    return k.preservenativescrolling && T.checkarea + 600 < e && (T.nativescrollingarea = T.isScrollable(t), i = !0), T.checkarea = e, !!T.nativescrollingarea || (T.railslocked ? T.cancelEvent(t) : S(t, !0, i))
                }
            }, this.stop = function () {
                return T.cancelScroll(), T.scrollmon && T.scrollmon.stop(), T.cursorfreezed = !1, T.scroll.y = Math.round(T.getScrollTop() * (1 / T.scrollratio.y)), T.noticeCursor(), T
            }, this.getTransitionSpeed = function (t) {
                return 80 + t / 72 * k.scrollspeed | 0
            }, k.smoothscroll)if (T.ishwscroll && N.hastransition && k.usetransition && k.smoothscroll) {
            var W = "";
            this.resetTransition = function () {
                W = "", T.doc.css(N.prefixstyle + "transition-duration", "0ms")
            }, this.prepareTransition = function (t, e) {
                var i = e ? t : T.getTransitionSpeed(t), n = i + "ms";
                return W !== n && (W = n, T.doc.css(N.prefixstyle + "transition-duration", n)), i
                ...
                running: !1, start: function () {
                    ...
                    if (!t.running) {
                        t.running = !0;
                        var e = function () {
                            t.running && h(e), T.showCursor(T.getScrollTop(), T.getScrollLeft()), T.notifyScrollEvent(T.win[0])
                        };
                        h(e)
                    }
                }, stop: function () {
                ...
                var n = T.getScrollTop(), o = T.getScrollLeft();
                if (((T.newscrolly - n) * (e - n) < 0 || (T.newscrollx - o) * (t - o) < 0) && T.cancelScroll(), k.bouncescroll ? (e < 0 ? e = e / 2 | 0 : e > T.page.maxh && (e = T.page.maxh + (e - T.page.maxh) / 2 | 0), t < 0 ? t = t / 2 | 0 : t > T.page.maxw && (t = T.page.maxw + (t - T.page.maxw) / 2 | 0)) : (e < 0 ? e = 0 : e > T.page.maxh && (e = T.page.maxh), t < 0 ? t = 0 : t > T.page.maxw && (t = T.page.maxw)), T.scrollrunning && t == T.newscrollx && e == T.newscrolly)return !1;
                T.newscrolly = e, T.newscrollx = t;
                var s = T.getScrollTop(), r = T.getScrollLeft(), a = {};
                a.x = t - r, a.y = e - s;
                var l = 0 | Math.sqrt(a.x * a.x + a.y * a.y), c = T.prepareTransition(l);
                T.scrollrunning || (T.scrollrunning = !0, T.triggerScrollStart(r, s, t, e, c), T.cursorupdate.start()), T.scrollendtrapped = !0, N.transitionend || (T.scrollendtrapped && clearTimeout(T.scrollendtrapped), T.scrollendtrapped = setTimeout(T.onScrollTransitionEnd, c)), T.setScrollTop(T.newscrolly), T.setScrollLeft(T.newscrollx)
            }, this.cancelScroll = function () {
                if (!T.scrollendtrapped)return !0;
                var t = T.getScrollTop(), e = T.getScrollLeft();
                return T.scrollrunning = !1, N.transitionend || clearTimeout(N.transitionend), T.scrollendtrapped = !1, T.resetTransition(), T.setScrollTop(t), T.railh && T.setScrollLeft(e), T.timerscroll && T.timerscroll.tm && clearInterval(T.timerscroll.tm), T.timerscroll = !1, T.cursorfreezed = !1, T.cursorupdate.stop(), T.showCursor(t, e), T
            }, this.onScrollTransitionEnd = function () {
                if (T.scrollendtrapped) {
                    var t = T.getScrollTop(), e = T.getScrollLeft();
                    if (t < 0 ? t = 0 : t > T.page.maxh && (t = T.page.maxh), e < 0 ? e = 0 : e > T.page.maxw && (e = T.page.maxw), t != T.newscrolly || e != T.newscrollx)return T.doScrollPos(e, t, k.snapbackspeed);
                    T.scrollrunning && T.triggerScrollEnd(), T.scrollrunning = !1, T.scrollendtrapped = !1, T.resetTransition(), T.timerscroll = !1, T.setScrollTop(t), T.railh && T.setScrollLeft(e), T.cursorupdate.stop(), T.noticeCursor(!1, t, e), T.cursorfreezed = !1
                }
            }
            ...
            var n = T.getScrollTop(), o = T.getScrollLeft();
            ((T.newscrolly - n) * (e - n) < 0 || (T.newscrollx - o) * (t - o) < 0) && T.cancelScroll();
            var s = !1;
            if (T.bouncescroll && T.rail.visibility || (e < 0 ? (e = 0, s = !0) : e > T.page.maxh && (e = T.page.maxh, s = !0)), T.bouncescroll && T.railh.visibility || (t < 0 ? (t = 0, s = !0) : t > T.page.maxw && (t = T.page.maxw, s = !0)), T.scrollrunning && T.newscrolly === e && T.newscrollx === t)return !0;
            T.newscrolly = e, T.newscrollx = t, T.dst = {}, T.dst.x = t - o, T.dst.y = e - n, T.dst.px = o, T.dst.py = n;
            var r = 0 | Math.sqrt(T.dst.x * T.dst.x + T.dst.y * T.dst.y), a = T.getTransitionSpeed(r);
            T.bzscroll = {};
            var l = s ? 1 : .58;
            T.bzscroll.x = new $(o, T.newscrollx, a, 0, 0, l, 1), T.bzscroll.y = new $(n, T.newscrolly, a, 0, 0, l, 1), m();
            var c = function () {
                if (T.scrollrunning) {
                    var t = T.bzscroll.y.getPos();
                    T.setScrollLeft(T.bzscroll.x.getNow()), T.setScrollTop(T.bzscroll.y.getNow()), t <= 1 ? T.timer = h(c) : (T.scrollrunning = !1, T.timer = 0, T.triggerScrollEnd())
                }
            };
            T.scrollrunning || (T.triggerScrollStart(o, n, t, e, a), T.scrollrunning = !0, T.timer = h(c))
        }, this.cancelScroll = function () {
            return T.timer && d(T.timer), T.timer = 0, T.bzscroll = !1, T.scrollrunning = !1, T
        }; else this.doScrollLeft = function (t, e) {
            ...
            var n = t > T.page.maxw ? T.page.maxw : t;
            n < 0 && (n = 0);
            var o = e > T.page.maxh ? T.page.maxh : e;
            o < 0 && (o = 0), T.synched("scroll", function () {
                T.setScrollTop(o), T.setScrollLeft(n)
            })
        }, this.cancelScroll = function () {
        };
        this.doScrollBy = function (t, e) {
            ...
            var i = e ? Math.round(t * T.scrollratio.y) : t;
            i < 0 ? i = 0 : i > T.page.maxh && (i = T.page.maxh), T.cursorfreezed = !1, T.doScrollTop(t)
        }, this.checkContentSize = function () {
            var t = T.getContentSize();
            t.h == T.page.h && t.w == T.page.w || T.resize(!1, t)
        }, T.onscroll = function (t) {
            T.rail.drag || T.cursorfreezed || T.synched("scroll", function () {
                T.scroll.y = Math.round(T.getScrollTop() / T.scrollratio.y), T.railh && (T.scroll.x = Math.round(T.getScrollLeft() / T.scrollratio.x)), T.noticeCursor()
            })
        }, T.bind(T.docscroll, "scroll", T.onscroll), this.doZoomIn = function (t) {
            if (!T.zoomactive) {
                T.zoomactive = !0, T.zoomrestore = {style: {}};
                var e = ["position", "top", "left", "zIndex", "backgroundColor", "marginTop", "marginBottom", "marginLeft", "marginRight"], i = T.win[0].style;
                for (var n in e) {
                    var o = e[n];
                    T.zoomrestore.style[o] = void 0 !== i[o] ? i[o] : ""
                }
                T.zoomrestore.style.width = T.win.css("width"), T.zoomrestore.style.height = T.win.css("height"), T.zoomrestore.padding = {
                    w: T.win.outerWidth() - T.win.width(),
                    h: T.win.outerHeight() - T.win.height()
                }, N.isios4 && (T.zoomrestore.scrollTop = c.scrollTop(), c.scrollTop(0)), T.win.css({
                    position: N.isios4 ? "absolute" : "fixed",
                    top: 0,
                    left: 0,
                    zIndex: s + 100,
                    margin: 0
                });
                var r = T.win.css("backgroundColor");
                return ("" === r || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(r)) && T.win.css("backgroundColor", "#fff"), T.rail.css({zIndex: s + 101}), T.zoom.css({zIndex: s + 102}), T.zoom.css("backgroundPosition", "0 -18px"), T.resizeZoom(), T.onzoomin && T.onzoomin.call(T), T.cancelEvent(t)
            }
        }, this.doZoomOut = function (t) {
            if (T.zoomactive)return T.zoomactive = !1, T.win.css("margin", ""), T.win.css(T.zoomrestore.style), N.isios4 && c.scrollTop(T.zoomrestore.scrollTop), T.rail.css({"z-index": T.zindex}), T.zoom.css({"z-index": T.zindex}), T.zoomrestore = !1, T.zoom.css("backgroundPosition", "0 0"), T.onResize(), T.onzoomout && T.onzoomout.call(T), T.cancelEvent(t)
        }, this.doZoom = function (t) {
            return T.zoomactive ? T.doZoomOut(t) : T.doZoomIn(t)
        ...
        this.nc = t, this.lastx = 0, this.lasty = 0, this.speedx = 0, this.speedy = 0, this.lasttime = 0, this.steptime = 0, this.snapx = !1, this.snapy = !1, this.demulx = 0, this.demuly = 0, this.lastscrollx = -1, this.lastscrolly = -1, this.chkx = 0, this.chky = 0, this.timer = 0, this.reset = function (t, i) {
            e.stop(), e.steptime = 0, e.lasttime = m(), e.speedx = 0, e.speedy = 0, e.lastx = t, e.lasty = i, e.lastscrollx = -1, e.lastscrolly = -1
        }, this.update = function (t, i) {
            var n = m();
            e.steptime = n - e.lasttime, e.lasttime = n;
            var o = i - e.lasty, s = t - e.lastx, r = e.nc.getScrollTop() + o, a = e.nc.getScrollLeft() + s;
            e.snapx = a < 0 || a > e.nc.page.maxw, e.snapy = r < 0 || r > e.nc.page.maxh, e.speedx = s, e.speedy = o, e.lastx = t, e.lasty = i
        }, this.stop = function () {
            ...
            var n = !1;
            i < 0 ? (i = 0, n = !0) : i > e.nc.page.maxh && (i = e.nc.page.maxh, n = !0), t < 0 ? (t = 0, n = !0) : t > e.nc.page.maxw && (t = e.nc.page.maxw, n = !0), n ? e.nc.doScrollPos(t, i, e.nc.opt.snapbackspeed) : e.nc.triggerScrollEnd()
        }, this.doMomentum = function (t) {
            var i = m(), n = t ? i + t : e.lasttime, o = e.nc.getScrollLeft(), s = e.nc.getScrollTop(), r = e.nc.page.maxh, a = e.nc.page.maxw;
            e.speedx = a > 0 ? Math.min(60, e.speedx) : 0, e.speedy = r > 0 ? Math.min(60, e.speedy) : 0;
            var l = n && i - n <= 60;
            (s < 0 || s > r || o < 0 || o > a) && (l = !1);
            var c = !(!e.speedy || !l) && e.speedy, u = !(!e.speedx || !l) && e.speedx;
            if (c || u) {
                ...
                var p = e.lastscrollx, f = e.lastscrolly, g = function () {
                    var t = m() - i > 600 ? .04 : .02;
                    e.speedx && (p = Math.floor(e.lastscrollx - e.speedx * (1 - e.demulxy)), e.lastscrollx = p, (p < 0 || p > a) && (t = .1)), e.speedy && (f = Math.floor(e.lastscrolly - e.speedy * (1 - e.demulxy)), e.lastscrolly = f, (f < 0 || f > r) && (t = .1)), e.demulxy = Math.min(1, e.demulxy + t), e.nc.synched("domomentum2d", function () {
    ...
    t.cssHooks.pageYOffset = {
        get: function (t, e, i) {
            var n = r.data(t, "__nicescroll") || !1;
            return n && n.ishwscroll ? n.getScrollTop() : _.call(t)
        }, set: function (t, e) {
            var i = r.data(t, "__nicescroll") || !1;
        ...
        return this.each(function () {
            ...
            e && e.ishwscroll ? e.setScrollTop(parseInt(t)) : _.call(r(this), t)
        })
    };
    ...
    r.cssHooks.pageXOffset = {
        get: function (t, e, i) {
            var n = r.data(t, "__nicescroll") || !1;
            return n && n.ishwscroll ? n.getScrollLeft() : x.call(t)
        }, set: function (t, e) {
            var i = r.data(t, "__nicescroll") || !1;
    ...
    var C = function (t) {
        ...
        if (this.length = 0, this.name = "nicescrollarray", this.each = function (t) {
            ...
            var n = r.data(t[i], "__nicescroll") || !1;
            n && (this[this.length] = n, this.length++)
        }
        return this
    };
    !function (t, e, i) {
        for (var n = 0, o = e.length; n < o; n++)!function (t, e) {
            t[e] = function () {
                var t = arguments;
                return this.each(function () {
                    this[e].apply(this, t)
    ...
    }(C.prototype, ["show", "hide", "toggle", "onResize", "resize", "remove", "stop", "doScrollPos"]), t.fn.getNiceScroll = function (t) {
        return void 0 === t ? new C(this) : this[t] && r.data(this[t], "__nicescroll") || !1
    }, (t.expr.pseudos || t.expr[":"]).nicescroll = function (t) {
        return void 0 !== r.data(t, "__nicescroll")
    }, r.fn.niceScroll = function (t, e) {
        void 0 !== e || "object" != typeof t || "jquery" in t || (e = t, t = !1);
        var i = new C;
        return this.each(function () {
            var n = r(this), o = r.extend({}, e);
            if (t) {
                var s = r(t);
                o.doc = s.length > 1 ? r(t, n) : s, o.win = n
            }
            !("doc" in o) || "win" in o || (o.win = n);
            var a = n.data("__nicescroll") || !1;
            a || (o.doc = o.doc || n, a = new w(o, n), n.data("__nicescroll", a)), i.push(a)
        }), 1 === i.length ? i[0] : i
    }, l.NiceScroll = {
        getjQuery: function () {
            return t
        }
    }, r.nicescroll || (r.nicescroll = new C, r.nicescroll.options = g)
}), $.fn.easeScroll = function (t) {
    !function () {
        function e() {
            w.keyboardSupport && !0 && c("keydown", s)
        }

        function i() {
            if (document.body) {
                var t = document.body, i = document.documentElement, n = window.innerHeight, o = t.scrollHeight;
                if (S = document.compatMode.indexOf("CSS") >= 0 ? i : t, g = t, e(), C = !0, top != self)_ = !0; else if (o > n && (t.offsetHeight <= n || i.offsetHeight <= n)) {
                    var s = !1, r = function () {
                        s || i.scrollHeight == document.height || (s = !0, setTimeout(function () {
                            i.style.height = document.height + "px", s = !1
                        }, 100))
                    };
                    if (i.style.height = "auto", setTimeout(r, 10), S.offsetHeight <= n) {
        ...
        function n(t, e, i, n) {
            if (n || (n = 1e3), h(e, i), 1 != w.accelerationMax) {
                var o = +new Date, s = o - D;
                if (s < w.accelerationDelta) {
                    var r = (1 + 30 / s) / 2;
                    r > 1 && (r = Math.min(r, w.accelerationMax), e *= r, i *= r)
                }
                D = +new Date
            }
            if (k.push({x: e, y: i, lastX: 0 > e ? .99 : -.99, lastY: 0 > i ? .99 : -.99, start: +new Date}), !z) {
                var a = t === document.body, l = function () {
                    for (var o = +new Date, s = 0, r = 0, c = 0; c < k.length; c++) {
                        var u = k[c], h = o - u.start, d = h >= w.animationTime, p = d ? 1 : h / w.animationTime;
                        w.pulseAlgorithm && (p = m(p));
                        var f = u.x * p - u.lastX >> 0, g = u.y * p - u.lastY >> 0;
                        s += f, r += g, u.lastX += f, u.lastY += g, d && (k.splice(c, 1), c--)
                    }
                    a ? window.scrollBy(s, r) : (s && (t.scrollLeft += s), r && (t.scrollTop += r)), e || i || (k = []), k.length ? O(l, t, n / w.frameRate + 1) : z = !1
                };
                O(l, t, 0), z = !0
            }
        }
        ...
        function o(t) {
            C || i();
            var e = t.target, o = l(e);
            if (!o || t.defaultPrevented || u(g, "embed") || u(e, "embed") && /\.pdf/i.test(e.src))return !0;
            var s = t.wheelDeltaX || 0, r = t.wheelDeltaY || 0;
            return s || r || (r = t.wheelDelta || 0), !(w.touchpadSupport || !d(r)) || (Math.abs(s) > 1.2 && (s *= w.stepSize / 120), Math.abs(r) > 1.2 && (r *= w.stepSize / 120), n(o, -s, -r), void t.preventDefault())
        }

        function s(t) {
            var e = t.target, i = t.ctrlKey || t.altKey || t.metaKey || t.shiftKey && t.keyCode !== E.spacebar;
            ...
            var o, s = 0, r = 0, a = l(g), c = a.clientHeight;
            switch (a == document.body && (c = window.innerHeight), t.keyCode) {
                ...
                case E.home:
                    ...
                    break;
                case E.end:
                    var h = a.scrollHeight - a.scrollTop - c;
                    r = h > 0 ? h + 10 : 0;
                    break;
                case E.left:
                    s = -w.arrowScroll;
        ...
        function a(t, e) {
            for (var i = t.length; i--;)I[L(t[i])] = e;
            return e
        }
        ...
        function l(t) {
            ...
            do {
                ...
                if (e.push(t), i === t.scrollHeight) {
                    if (!_ || S.clientHeight + 10 < i)return a(e, document.body)
        ...
        function h(t, e) {
            t = t > 0 ? 1 : -1, e = e > 0 ? 1 : -1, (x.x !== t || x.y !== e) && (x.x = t, x.y = e, k = [], D = 0)
        }

        function d(t) {
            if (t) {
                t = Math.abs(t), T.push(t), T.shift(), clearTimeout(N);
        ...
        var g, v = $.extend({
            ...
            x: 0,
            y: 0
        }, C = !1, S = document.documentElement, T = [120, 120, 120], E = {
            left: 37,
            up: 38,
            right: 39,
            down: 40,
        ...
        }(), A = /chrome|iPad/i.test(window.navigator.userAgent);
        "onmousewheel" in document && A && (c("mousedown", r), c("mousewheel", o), c("load", i))
    }()
}, function (t, e) {
    ...
    return o.prototype.addElementBackgroundImages = function (t) {
        ...
        this.progressedCount == this.images.length && this.complete(), this.options.debug && l && l.log("progress: " + i, t, e)
    ...
    function s(e) {
        if (o(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            var m = a.paddingLeft + a.paddingRight, g = a.paddingTop + a.paddingBottom, v = a.marginLeft + a.marginRight, y = a.marginTop + a.marginBottom, w = a.borderLeftWidth + a.borderRightWidth, b = a.borderTopWidth + a.borderBottomWidth, _ = u && r, x = t(s.width);
            !1 !== x && (a.width = x + (_ ? 0 : m + w));
            var C = t(s.height);
            return !1 !== C && (a.height = C + (_ ? 0 : g + b)), a.innerWidth = a.width - (m + w), a.innerHeight = a.height - (g + b), a.outerWidth = a.width + v, a.outerHeight = a.height + y, a
        }
    }
    ...
    return n._resetLayout = function () {
        ...
        for (var o = this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition", s = this[o](n, t), r = {
            ...
            y: s.y
        }, a = s.y + t.size.outerHeight, l = n + s.col, c = s.col; c < l; c++)this.colYs[c] = a;
        return r
    ...
    var d = function () {
        function t(t) {
            ...
            var i = c(t).split(" "), n = i[0], o = n.match(/^\[(.+)\]$/), s = o && o[1], r = e(s, n), a = u.sortDataParsers[i[1]];
    ...
    o.Defaults = {autoHeight: !1, autoHeightClass: "owl-height"}, o.prototype.update = function () {
        var e = this._core._current, i = e + this._core.settings.items, n = this._core.$stage.children().toArray().slice(e, i), o = [], s = 0;
    ...
    o.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, o.prototype.fetch = function (t, e) {
        ...
        }(), n = t.attr("data-vimeo-id") || t.attr("data-youtube-id") || t.attr("data-vzaar-id"), o = t.attr("data-width") || this._core.settings.videoWidth, s = t.attr("data-height") || this._core.settings.videoHeight, r = t.attr("href");
        ...
        var i, n = t(e.target), o = n.closest("." + this._core.settings.itemClass), s = this._videos[o.attr("data-video")], r = s.width || "100%", a = s.height || this._core.$stage.height();
    ...
    o.Defaults = {
        ...
        var t, e, i, n = this._core.clones().length / 2, o = n + this._core.items().length, s = this._core.maximum(!0), r = this._core.settings, a = r.center || r.autoWidth || r.dotsData ? 1 : r.dotsEach || r.items;
    ...
    var e = -1, i = -1, n = function (t) {
        ...
        return i.each(function () {
            var e = t(this), i = e.offset().top - n(e.css("margin-top")), r = s.length > 0 ? s[s.length - 1] : null;
    ...
    r.version = "0.7.2", r._groups = [], r._throttle = 80, r._maintainScroll = !1, r._beforeUpdate = null, r._afterUpdate = null, r._rows = o, r._parse = n, r._parseOptions = s, r._apply = function (e, i) {
        var a = s(i), l = t(e), c = [l], u = t(window).scrollTop(), h = t("html").outerHeight(!0), d = l.parents().filter(":hidden");
    ...
    function s(t, e) {
        var i = t.getBoundingClientRect(), n = t.ownerDocument, o = n.documentElement, s = f(n);
    ...
    function S(t, e, i) {
        ...
        var n, o, s, r, a = x(i, e);
        return n = t[a - 1], o = t[a], s = e[a - 1], r = e[a], _([n, o], (i - s) * y(s, r))
    }
    ...
    function k(t, e, i) {
        ...
        var n = (i.xVal[t + 1] - i.xVal[t]) / i.xNumSteps[t], o = Math.ceil(Number(n.toFixed(3)) - 1), s = i.xVal[t] + i.xNumSteps[t] * o;
    ...
    function z(t, e, i) {
        ...
        for (o.sort(o.length && "object" == typeof o[0][0] ? function (t, e) {
            ...
            return t[0] - e[0]
        }), n = 0; n < o.length; n++)E(o[n][1], o[n][0], this);
        for (this.xNumSteps = this.xSteps.slice(0), n = 0; n < this.xNumSteps.length; n++)k(n, this.xNumSteps[n], this)
    }
    ...
    function N(t, e) {
        ...
        t.spectrum = new z(e, t.snap, t.singleStep)
    }
    ...
    function F(t, e) {
        ...
        var i = e.indexOf("tap") >= 0, n = e.indexOf("drag") >= 0, o = e.indexOf("fixed") >= 0, s = e.indexOf("snap") >= 0, r = e.indexOf("hover") >= 0;
        if (o) {
    ...
    function G(t, o, r) {
        ...
        function y(t, e) {
            var i = u(t, o.cssClasses.origin), n = u(i, o.cssClasses.handle);
        ...
        function x(t, e, i) {
            ...
            var s = {}, r = ft.xVal[0], a = ft.xVal[ft.xVal.length - 1], l = !1, c = !1, u = 0;
            return i = n(i.slice().sort(function (t, e) {
                return t - e
            })), i[0] !== r && (i.unshift(r), l = !0), i[i.length - 1] !== a && (i.push(a), c = !0), i.forEach(function (n, r) {
                var a, h, d, p, f, m, g, v, y, w, b = n, _ = i[r + 1];
                if ("steps" === e && (a = ft.xNumSteps[r]), a || (a = _ - b), !1 !== b && void 0 !== _)for (a = Math.max(a, 1e-7), h = b; _ >= h; h = o(h, a)) {
                    for (p = ft.toStepping(h), f = p - u, v = f / t, y = Math.round(v), w = f / y, d = 1; y >= d; d += 1)m = u + d * w, s[m.toFixed(5)] = ["x", 0];
                    g = i.indexOf(h) > -1 ? 1 : "steps" === e ? 2 : 0, !r && l && (g = 0), h === _ && c || (s[p.toFixed(5)] = [h, g]), u = p
                }
            }), s
        }
        ...
        function C(t, e, i) {
            function n(t, e) {
                var i = e === o.cssClasses.value, n = i ? c : d, s = i ? a : l;
            ...
            function s(t, s) {
                ...
                var a = u(r, !1);
                a.className = n(s[1], o.cssClasses.marker), a.style[o.style] = t + "%", s[1] && (a = u(r, !1), a.className = n(s[1], o.cssClasses.value), a.style[o.style] = t + "%", a.innerText = i.to(s[0]))
            }

            var r = yt.createElement("div"), a = [o.cssClasses.valueNormal, o.cssClasses.valueLarge, o.cssClasses.valueSub], l = [o.cssClasses.markerNormal, o.cssClasses.markerLarge, o.cssClasses.markerSub], c = [o.cssClasses.valueHorizontal, o.cssClasses.valueVertical], d = [o.cssClasses.markerHorizontal, o.cssClasses.markerVertical];
        ...
        function T(t) {
            S();
            var e = t.mode, i = t.density || 1, n = t.filter || !1, o = t.values || !1, s = t.stepped || !1, r = _(e, o, s), a = x(i, e, r), l = t.format || {to: Math.round};
            return rt = ut.appendChild(C(a, n, l))
        }

        function E() {
            var t = it.getBoundingClientRect(), e = "offset" + ["Width", "Height"][o.ort];
            return 0 === o.ort ? t.width || it[e] : t.height || it[e]
        }

        function k(t, e, i, n) {
            var s = function (e) {
                return !ut.hasAttribute("disabled") && (!p(ut, o.cssClasses.tap) && (!!(e = z(e, n.pageOffset)) && (!(t === at.start && void 0 !== e.buttons && e.buttons > 1) && ((!n.hover || !e.buttons) && (ct || e.preventDefault(), e.calcPoint = e.points[o.ort], void i(e, n))))))
            }, r = [];
            return t.split(" ").forEach(function (t) {
                e.addEventListener(t, s, !!ct && {passive: !0}), r.push([t, s])
            }), r
        }

        function z(t, e) {
            var i, n, o = 0 === t.type.indexOf("touch"), s = 0 === t.type.indexOf("mouse"), r = 0 === t.type.indexOf("pointer");
            if (0 === t.type.indexOf("MSPointer") && (r = !0), o) {
                if (t.touches.length > 1)return !1;
                i = t.changedTouches[0].pageX, n = t.changedTouches[0].pageY
            }
            return e = e || f(yt), (s || r) && (i = t.clientX + e.x, n = t.clientY + e.y), t.pageOffset = e, t.points = [i, n], t.cursor = s || r, t
        }

        function D(t) {
            var e = t - s(it, o.ort), i = 100 * e / E();
        ...
        function N(t, e, i, n) {
            ...
            n = n.slice(), t && n.reverse(), n.length > 1 ? n.forEach(function (t, i) {
                var n = R(o, t, o[t] + e, s[i], r[i], !1);
                !1 === n ? e = 0 : (e = n - o[t], o[t] = n)
            }) : s = r = [!0];
            var a = !1;
            n.forEach(function (t, n) {
                a = W(t, i[t] + e, s[n], r[n]) || a
        ...
        function $(t, e, i) {
            Object.keys(gt).forEach(function (n) {
                var s = n.split(".")[0];
                t === s && gt[n].forEach(function (t) {
                    t.call(st, mt.map(o.format.to), e, mt.slice(), i || !1, ht.slice())
                })
            })
        }
        ...
        function A(t, e) {
            pt && (d(pt, o.cssClasses.active), pt = !1), t.cursor && (bt.style.cursor = "", bt.removeEventListener("selectstart", i)), vt.forEach(function (t) {
                wt.removeEventListener(t[0], t[1])
            }), d(ut, o.cssClasses.drag), F(), e.handleNumbers.forEach(function (t) {
        ...
        function j(t, e) {
            if (1 === e.handleNumbers.length) {
                ...
                pt = n.children[0], h(pt, o.cssClasses.active)
            }
            t.stopPropagation();
            var s = k(at.move, wt, O, {
                ...
                locations: ht.slice()
            }), r = k(at.end, wt, A, {handleNumbers: e.handleNumbers}), a = k("mouseout", wt, L, {handleNumbers: e.handleNumbers});
            vt = s.concat(r, a), t.cursor && (bt.style.cursor = getComputedStyle(t.target).cursor, nt.length > 1 && h(ut, o.cssClasses.drag), bt.addEventListener("selectstart", i, !1)), e.handleNumbers.forEach(function (t) {
                $("start", t)
            })
        }
        ...
        function M(t) {
            t.stopPropagation();
            var e = D(t.calcPoint), i = I(e);
            return !1 !== i && (o.events.snap || a(ut, o.cssClasses.tap, o.animationDuration), W(i, e, !0, !0), F(), $("slide", i, !0), $("update", i, !0), $("change", i, !0), $("set", i, !0), void(o.events.snap && j(t, {handleNumbers: [i]})))
        }

        function P(t) {
            var e = D(t.calcPoint), i = ft.getStep(e), n = ft.fromStepping(i);
        ...
        function q(t, e) {
            ht[t] = e, mt[t] = ft.fromStepping(e);
            var i = function () {
                nt[t].style[o.style] = H(e), B(t), B(t + 1)
            };
        ...
        function F() {
            dt.forEach(function (t) {
                var e = ht[t] > 50 ? -1 : 1, i = 3 + (nt.length + e * t);
                nt[t].childNodes[0].style.zIndex = i
            })
        }

        function W(t, e, i, n) {
            return !1 !== (e = R(ht, t, e, i, n, !1)) && (q(t, e), !0)
        }

        function B(t) {
            if (ot[t]) {
                var e = 0, i = 100;
                0 !== t && (e = ht[t - 1]), t !== ot.length - 1 && (i = ht[t]), ot[t].style[o.style] = H(e), ot[t].style[o.styleOposite] = H(100 - i)
            }
        }

        function U(t, e) {
            null !== t && !1 !== t && ("number" == typeof t && (t = String(t)), !1 === (t = o.format.from(t)) || isNaN(t) || W(e, ft.toStepping(t), !1, !1))
        }

        function Y(t, e) {
            var i = c(t), n = void 0 === ht[0];
            e = void 0 === e || !!e, i.forEach(U), o.animate && !n && a(ut, o.cssClasses.tap, o.animationDuration), dt.forEach(function (t) {
                W(t, ht[t], !0, !1)
            }), F(), dt.forEach(function (t) {
        ...
        function X() {
            var t = mt.map(o.format.to);
            return 1 === t.length ? t[0] : t
        }

        function G() {
            for (var t in o.cssClasses)o.cssClasses.hasOwnProperty(t) && d(ut, o.cssClasses[t]);
            for (; ut.firstChild;)ut.removeChild(ut.firstChild);
            delete ut.noUiSlider
        }

        function Z() {
            return ht.map(function (t, e) {
                var i = ft.getNearbySteps(t), n = mt[e], o = i.thisStep.step, s = null;
        ...
        function et(t, e) {
            var i = X(), n = ["margin", "limit", "padding", "range", "animate", "snap", "step", "format"];
            ...
            n.forEach(function (e) {
                void 0 !== t[e] && (o[e] = s[e])
            }), ft = s.spectrum, o.margin = s.margin, o.limit = s.limit, o.padding = s.padding, o.pips && T(o.pips), ht = [], Y(t.start || i, e)
        }

        var it, nt, ot, st, rt, at = m(), lt = v(), ct = lt && g(), ut = t, ht = [], dt = [], pt = !1, ft = o.spectrum, mt = [], gt = {}, vt = null, yt = t.ownerDocument, wt = yt.documentElement, bt = yt.body;
        if (ut.noUiSlider)throw new Error("noUiSlider (" + K + "): Slider was already initialized.");
        return function (t) {
            h(t, o.cssClasses.target), 0 === o.dir ? h(t, o.cssClasses.ltr) : h(t, o.cssClasses.rtl), 0 === o.ort ? h(t, o.cssClasses.horizontal) : h(t, o.cssClasses.vertical), it = u(t, o.cssClasses.base)
        }(ut), function (t, e) {
            nt = [], ot = [], ot.push(w(e, t[0]));
            for (var i = 0; i < o.handles; i++)nt.push(y(e, i)), dt[i] = i, ot.push(w(e, t[i + 1]))
        }(o.connect, it), st = {
            destroy: G,
            steps: Z,
            on: J,
            ...
            t.fixed || nt.forEach(function (t, e) {
                k(at.start, t.children[0], j, {handleNumbers: [e]})
            }), t.tap && k(at.start, it, M, {}), t.hover && k(at.move, it, P, {hover: !0}), t.drag && ot.forEach(function (e, i) {
                if (!1 !== e && 0 !== i && i !== ot.length - 1) {
                    var n = nt[i - 1], s = nt[i], r = [e];
                    h(e, o.cssClasses.draggable), t.fixed && (r.push(n.children[0]), r.push(s.children[0])), r.forEach(function (t) {
                        k(at.start, t, j, {handles: [n, s], handleNumbers: [i - 1, i]})
                    })
                }
            })
        }(o.events), Y(o.start), o.pips && T(o.pips), o.tooltips && function () {
            var t = nt.map(b);
            ...
            J("update", function (t, e, i, n, s) {
                dt.forEach(function (t) {
                    var e = nt[t], n = R(ht, t, 0, !0, !0, !0), r = R(ht, t, 100, !0, !0, !0), a = s[t], l = o.ariaFormat.to(i[t]);
    ...
    function Z(t, e) {
        ...
        var i = Q(e, t), n = G(t, i, e);
        return t.noUiSlider = n, n
    }

    var K = "10.0.0";
    z.prototype.getMargin = function (t) {
    ...
    }, z.prototype.toStepping = function (t) {
        return t = C(this.xVal, this.xPct, t)
    }, z.prototype.fromStepping = function (t) {
        return S(this.xVal, this.xPct, t)
    }, z.prototype.getStep = function (t) {
        return t = T(this.xPct, this.xSteps, this.snap, t)
    }, z.prototype.getNearbySteps = function (t) {
        var e = x(t, this.xPct);
        return {
            stepBefore: {
    ...
    n = function () {
        ...
        return t.prototype.set_default_values = function () {
            ...
            return this.result_clear_highlight(), 1 > o && r.length ? (this.update_results_content(""), this.no_results(r)) : (this.update_results_content(this.results_option_build()), this.winnow_results_set_highlight())
            ...
            if (this.enable_split_word_search && (t.indexOf(" ") >= 0 || 0 === t.indexOf("[")) && (n = t.replace(/\[|\]/g, "").split(" "), n.length))for (o = 0, s = n.length; s > o; o++)if (i = n[o], e.test(i))return !0
        ...
        return a(i, e), i.prototype.setup = function () {
            ...
            return this.form_field_label = this.form_field_jq.parents("label"), !this.form_field_label.length && this.form_field.id.length && (this.form_field_label = t("label[for='" + this.form_field.id + "']")), this.form_field_label.length > 0 ? this.form_field_label.bind("click.chosen", this.label_click_handler) : void 0
            ...
            return this.result_deselect(t[0].getAttribute("data-option-array-index")) ? (this.active_field ? this.search_field.focus() : this.show_search_field_default(), this.is_multiple && this.choices_count() > 0 && this.get_search_field_value().length < 1 && this.results_hide(), t.parents("li").first().remove(), this.search_field_scale()) : void 0
        }, i.prototype.results_reset = function () {
            return this.reset_single_select_options(),
                this.form_field.options[0].selected = !0, this.single_set_selected_text(), this.show_search_field_default(), this.results_reset_cleanup(), this.trigger_form_field_change(), this.active_field ? this.results_hide() : void 0
        }, i.prototype.results_reset_cleanup = function () {
            return this.current_selectedIndex = this.form_field.selectedIndex, this.selected_item.find("abbr").remove()
        }, i.prototype.result_select = function (t) {
            var e, i;
            return this.result_highlight ? (e = this.result_highlight, this.result_clear_highlight(), this.is_multiple && this.max_selected_options <= this.choices_count() ? (this.form_field_jq.trigger("chosen:maxselected", {chosen: this}), !1) : (this.is_multiple ? e.removeClass("active-result") : this.reset_single_select_options(), e.addClass("result-selected"), i = this.results_data[e[0].getAttribute("data-option-array-index")], i.selected = !0, this.form_field.options[i.options_index].selected = !0, this.selected_option_count = null, this.is_multiple ? this.choice_build(i) : this.single_set_selected_text(this.choice_label(i)), (!this.is_multiple || this.hide_results_on_select && !t.metaKey && !t.ctrlKey) && (this.results_hide(), this.show_search_field_default()), (this.is_multiple || this.form_field.selectedIndex !== this.current_selectedIndex) && this.trigger_form_field_change({selected: this.form_field.options[i.options_index].value}), this.current_selectedIndex = this.form_field.selectedIndex, t.preventDefault(), this.search_field_scale())) : void 0
            ...
            if (this.is_multiple) {
                for (o = {
                    ...
                    display: "none",
                    whiteSpace: "pre"
                }, s = ["fontSize", "fontStyle", "fontWeight", "fontFamily", "lineHeight", "textTransform", "letterSpacing"], a = 0, l = s.length; l > a; a++)n = s[a], o[n] = this.search_field.css(n);
    ...
    o.prototype.init = function () {
        ...
        function s(t, e) {
            e ? v.css({
                ...
                "-webkit-transition": "max-height " + f.transitionSpeed + "ms " + f.transitionEasing,
                transition: "max-height " + f.transitionSpeed + "ms " + f.transitionEasing
            })
        }
        ...
        function a(e, i, n, o) {
            var s, r = e.filter(".open").find("> [data-content]"), a = r.find("[data-accordion].open > [data-content]");
            f.singleOpen || (a = a.not(i.siblings("[data-accordion].open").find("> [data-content]"))), s = r.add(a), e.hasClass("open") && s.each(function () {
                var e = t(this).data("oHeight");
                switch (o) {
                    case"+":
                        t(this).data("oHeight", e + n);
                        break;
                    case"-":
                        t(this).data("oHeight", e - n);
                        break;
        ...
        function l(t) {
            if (t.hasClass("open")) {
                var e = t.find("> [data-content]"), i = e.find("[data-accordion].open > [data-content]"), n = e.add(i);
                r(n), n.css("max-height", n.data("oHeight"))
            }
        }

        function c(t, e) {
            if (t.trigger("accordion.close"), _) {
                if (w) {
                    a(t.parents("[data-accordion]"), t, e.data("oHeight"), "-")
                }
                e.css(b), t.removeClass("open")
            } else e.css("max-height", e.data("oHeight")), e.animate(b, f.transitionSpeed), t.removeClass("open")
        }

        function u(t, e) {
            if (t.trigger("accordion.open"), _) {
                if (s(e), w) {
                    a(t.parents("[data-accordion]"), t, e.data("oHeight"), "+")
                }
                o(function () {
            ...
            } else e.animate({"max-height": e.data("oHeight")}, f.transitionSpeed, function () {
                e.css({"max-height": "none"})
            }), t.addClass("open")
        }

        function h(e) {
            var i = (e.closest(f.groupElement), e.siblings("[data-accordion]").filter(".open")), n = i.find("[data-accordion]").filter(".open"), o = i.add(n);
            o.each(function () {
                var e = t(this);
                c(e, e.find(f.contentElement))
            }), o.removeClass("open")
        }

        function d() {
            var t = !!f.singleOpen && m.parents(f.groupElement).length > 0;
            r(v), t && h(m), m.hasClass("open") ? c(m, v) : u(m, v)
        }

        var p = this, f = p.options, m = t(p.element), g = m.find("> " + f.controlElement), v = m.find("> " + f.contentElement), y = m.parents("[data-accordion]").length, w = y > 0, b = {
            "max-height": 0,
            overflow: "hidden"
        }, _ = function () {
            ...
            n = "Transition";
            for (var s = 0; s < o.length; s++)if ("string" == typeof e[o[s] + n])return !0;
            return !1
        }();
        !function () {
            v.each(function () {
                var e = t(this);
                0 != e.css("max-height") && (e.closest("[data-accordion]").hasClass("open") ? (s(e), r(e), e.css("max-height", e.data("oHeight"))) : e.css({
                    "max-height": 0,
                    overflow: "hidden"
                }))
            }), m.attr("data-accordion") || (m.attr("data-accordion", ""), m.find(f.controlElement).attr("data-control", ""), m.find(f.contentElement).attr("data-content", ""))
        }(), function () {
            g.on("click", d), g.on("accordion.toggle", function () {
                if (f.singleOpen && g.length > 1)return !1;
                d()
            }), g.on("accordion.refresh", function () {
                l(m)
    ...
    function i(t) {
        ...
        var e, i, n, o, s = t.css("animation-duration") || t.css("-webkit-animation-duration") || t.css("-moz-animation-duration") || t.css("-o-animation-duration") || t.css("-ms-animation-duration") || "0s", r = t.css("animation-delay") || t.css("-webkit-animation-delay") || t.css("-moz-animation-delay") || t.css("-o-animation-delay") || t.css("-ms-animation-delay") || "0s", a = t.css("animation-iteration-count") || t.css("-webkit-animation-iteration-count") || t.css("-moz-animation-iteration-count") || t.css("-o-animation-iteration-count") || t.css("-ms-animation-iteration-count") || "1";
        for (s = s.split(", "), r = r.split(", "), a = a.split(", "), o = 0, i = s.length, e = Number.NEGATIVE_INFINITY; o < i; o++)(n = parseFloat(s[o]) * parseInt(a[o], 10) + parseFloat(r[o])) > e && (e = n);
        return e
    }

    function n() {
        if (e(document).height() <= e(window).height())return 0;
        var t, i, n = document.createElement("div"), o = document.createElement("div");
    ...
    function o() {
        if (!C) {
            var t, i, o = e("html"), s = u("is-locked");
    ...
    function r(t, e, i, n) {
        var o = u("is", e), s = [u("is", b.CLOSING), u("is", b.OPENING), u("is", b.CLOSED), u("is", b.OPENED)].join(" ");
    ...
    function c(t) {
        var e, i, n, o, s = {};
        for (t = t.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ","), e = t.split(","), o = 0, i = e.length; o < i; o++)e[o] = e[o].split(":"), n = e[o][1], ("string" == typeof n || n instanceof String) && (n = "true" === n || "false" !== n && n), ("string" == typeof n || n instanceof String) && (n = isNaN(n) ? n : +n), s[e[o][0]] = n;
        return s
    }
    ...
    function d(t, i) {
        var n = e(document.body), o = n, s = this;
        s.settings = e.extend({}, w, i), s.index = e[m].lookup.push(s) - 1, s.state = b.CLOSED, s.$overlay = e("." + u("overlay")), null !== s.settings.appendTo && s.settings.appendTo.length && (o = e(s.settings.appendTo)), s.$overlay.length || (s.$overlay = e("<div>").addClass(u("overlay") + " " + u("is", b.CLOSED)).hide(), o.append(s.$overlay)), s.$bg = e("." + u("bg")).addClass(u("is", b.CLOSED)), s.$modal = t.addClass(g + " " + u("is-initialized") + " " + s.settings.modifier + " " + u("is", b.CLOSED)).attr("tabindex", "-1"), s.$wrapper = e("<div>").addClass(u("wrapper") + " " + s.settings.modifier + " " + u("is", b.CLOSED)).hide().append(s.$modal), o.append(s.$wrapper), s.$wrapper.on("click." + g, '[data-remodal-action="close"]', function (t) {
            t.preventDefault(), s.close()
        }), s.$wrapper.on("click." + g, '[data-remodal-action="cancel"]', function (t) {
            t.preventDefault(), s.$modal.trigger(_.CANCELLATION), s.settings.closeOnCancel && s.close(_.CANCELLATION)
        }), s.$wrapper.on("click." + g, '[data-remodal-action="confirm"]', function (t) {
            t.preventDefault(), s.$modal.trigger(_.CONFIRMATION), s.settings.closeOnConfirm && s.close(_.CONFIRMATION)
        }), s.$wrapper.on("click." + g, function (t) {
            e(t.target).hasClass(u("wrapper")) && s.settings.closeOnOutsideClick && s.close()
        })
    }

    var p, f, m = "remodal", g = t.REMODAL_GLOBALS && t.REMODAL_GLOBALS.NAMESPACE || m, v = e.map(["animationstart", "webkitAnimationStart", "MSAnimationStart", "oAnimationStart"], function (t) {
        return t + "." + g
    }).join(" "), y = e.map(["animationend", "webkitAnimationEnd", "MSAnimationEnd", "oAnimationEnd"], function (t) {
        return t + "." + g
    }).join(" "), w = e.extend({
        hashTracking: !0,
        closeOnConfirm: !0,
        ...
        modifier: "",
        appendTo: null
    }, t.REMODAL_GLOBALS && t.REMODAL_GLOBALS.DEFAULTS), b = {
        CLOSING: "closing",
        CLOSED: "closed",
        OPENING: "opening",
        OPENED: "opened"
    }, _ = {CONFIRMATION: "confirmation", CANCELLATION: "cancellation"}, x = function () {
    ...
    d.prototype.open = function () {
        ...
        var i = this;
        i.state !== b.OPENING && i.state !== b.CLOSING && i.state !== b.CLOSED && (i.settings.hashTracking && i.$modal.attr("data-remodal-id") === location.hash.substr(1) && (location.hash = "", e(window).scrollTop(f)), a(function () {
            r(i, b.CLOSING, !1, t)
        }, function () {
        ...
        l(this), this.$wrapper.remove(), delete t[this.index], 0 === e.grep(t, function (t) {
            return !!t
        }).length && (this.$overlay.remove(), this.$bg.removeClass(u("is", b.CLOSING) + " " + u("is", b.OPENING) + " " + u("is", b.CLOSED) + " " + u("is", b.OPENED)))
    }, e[m] = {lookup: []}, e.fn[m] = function (t) {
        var i, n;
        return this.each(function (o, s) {
            n = e(s), null == n.data(m) ? (i = new d(n, t), n.data(m, i.index), i.settings.hashTracking && n.attr("data-remodal-id") === location.hash.substr(1) && i.open()) : i = e[m].lookup[n.data(m)]
        }), i
    }, e(document).ready(function () {
        e(document).on("click", "[data-remodal-target]", function (t) {
            t.preventDefault();
            var i = t.currentTarget, n = i.getAttribute("data-remodal-target"), o = e('[data-remodal-id="' + n + '"]');
            e[m].lookup[o.data(m)].open()
        }), e(document).find("." + g).each(function (t, i) {
            var n = e(i), o = n.data("remodal-options");
    ...
    var e = "animsition", i = {
        init: function (n) {
            ...
            return o || !(n.browser.length > 0) || o && this.length ? (i.optionCheck.call(this, n) && t("." + n.overlayClass).length <= 0 && i.addOverlay.call(this, n), n.loading && t("." + n.loadingClass).length <= 0 && i.addLoading.call(this, n), this.each(function () {
                var o = this, s = t(this), r = t(window), a = t(document);
                s.data(e) || (n = t.extend({}, n), s.data(e, {options: n}), n.timeout && i.addTimer.call(o), n.onLoadEvent && r.on("load." + e, function () {
            ...
            var n = this, o = t(this), s = o.data(e).options;
            i.settings.timer = setTimeout(function () {
                i.in.call(n), t(window).off("load." + e)
            }, s.timeoutCountdown)
        }, supportCheck: function (e) {
            var i = t(this), n = e.browser, o = n.length, s = !1;
            0 === o && (s = !0);
            for (var r = 0; o > r; r++)if ("string" == typeof i.css(n[r])) {
                s = !0;
                break
            }
            return s
            ...
            var s = t(this), r = s.data(e).options, a = typeof i, l = !n && "number" === a, c = n && "string" === a && i.length > 0;
            return l || c ? i = i : n && o ? i = r.inClass : !n && o ? i = r.inDuration : n && !o ? i = r.outClass : n || o || (i = r.outDuration), i
        }, in: function () {
            var n = this, o = t(this), s = o.data(e).options, r = o.data(i.settings.data.inDuration), a = o.data(i.settings.data.inClass), l = i.animationCheck.call(n, r, !1, !0), c = i.animationCheck.call(n, a, !0, !0), u = i.optionCheck.call(n, s), h = o.data(e).outClass;
            s.loading && i.removeLoading.call(n), h && o.removeClass(h), u ? i.inOverlay.call(n, c, l) : i.inDefault.call(n, c, l)
        }, inDefault: function (e, n) {
            var o = t(this);
            o.css({"animation-duration": n + "ms"}).addClass(e).trigger(i.settings.events.inStart).animateCallback(function () {
                o.removeClass(e).css({opacity: 1}).trigger(i.settings.events.inEnd)
            })
        }, inOverlay: function (n, o) {
            var s = t(this), r = s.data(e).options;
            s.css({opacity: 1}).trigger(i.settings.events.inStart), t(r.overlayParentElement).children("." + r.overlayClass).css({"animation-duration": o + "ms"}).addClass(n).animateCallback(function () {
                s.trigger(i.settings.events.inEnd)
            })
        }, out: function (n, o) {
            var s = this, r = t(this), a = r.data(e).options, l = n.data(i.settings.data.outClass), c = r.data(i.settings.data.outClass), u = n.data(i.settings.data.outDuration), h = r.data(i.settings.data.outDuration), d = l || c, p = u || h, f = i.animationCheck.call(s, d, !0, !1), m = i.animationCheck.call(s, p, !1, !1), g = i.optionCheck.call(s, a);
            ...
            r.css({"animation-duration": o + 1 + "ms"}).addClass(n).trigger(i.settings.events.outStart).animateCallback(function () {
                r.trigger(i.settings.events.outEnd), a.transition(s)
            })
        }, outOverlay: function (n, o, s) {
            var r = this, a = t(this), l = a.data(e).options, c = a.data(i.settings.data.inClass), u = i.animationCheck.call(r, c, !0, !0);
            t(l.overlayParentElement).children("." + l.overlayClass).css({"animation-duration": o + 1 + "ms"}).removeClass(u).addClass(n).trigger(i.settings.events.outStart).animateCallback(function () {
    ...
    function e() {
        ...
        t(".parallax").each(function (i) {
            var n = t(this), o = n.width(), s = n.height(), r = n.attr("data-img-width"), a = n.attr("data-img-height"), l = r / a, c = 100;
            c = c || 0;
            var u = 0;
            n.hasClass("parallax") && !t("html").hasClass("touch") && (u = e - s), a = s + u + c, r = a * l, o > r && (r = o, a = r / l), n.data("resized-imgW", r), n.data("resized-imgH", a), n.css("background-size", r + "px " + a + "px")
        })
    }

    function i(e) {
        var i = t(window).height(), n = t(window).scrollTop(), o = n + i, s = (n + o) / 2;
        t(".parallax").each(function (e) {
            var r = t(this), a = r.height(), l = r.offset().top, c = l + a;
            if (o > l && n < c) {
                var u = r.data("resized-imgH"), h = -u + i, d = a < i ? u - a : u - i;
                l -= d, c += d;
                var p = 0;
                p = t(".parallax").is(".titlebar") ? 0 + (h - 0) * (s - l) / (c - l) * 2 : 0 + (h - 0) * (s - l) / (c - l);
                var f = r.attr("data-oriz-pos");
                f = f || "50%", t(this).css("background-position", f + " " + p + "px")
            }
        })
    }

    var n = t("body"), o = t("html"), s = t(".customScrollbar");
    s.each(function () {
        var e = {
            cursorcolor: "#424242",
            cursorwidth: "5px",
        ...
        for (var i in e)e.hasOwnProperty(i) && null != t(this).attr("data-scroll-" + i) && (e[i] = t(this).data("scroll-" + i));
        t(this).niceScroll({
            cursorcolor: e.cursorcolor,
            cursorwidth: e.cursorwidth,
            cursorborder: e.cursorborder,
            scrollspeed: e.scrollspeed,
            mousescrollstep: e.mousescrollstep,
            cursoropacitymax: e.cursoropacitymax
        })
    }), t(".js-navbar").find(".navbar-menu i").on("click", function (e) {
        t(this).siblings(".drop-menu").slideToggle("fast", function () {
            s.getNiceScroll().resize()
        }), t(this).siblings("a").toggleClass("active"), t(this).toggleClass("clicked"), e.stopPropagation()
    });
    var r = t(".header-navbar"), a = t(".header-navbar-mobile"), l = t(".js-toggle-navbar-mobile"), c = t(".js-toggle-navbar"), u = t(".js-close-navbar");
    c.on("click", function () {
        r.toggleClass("opened")
    }), l.on("click", function () {
        a.slideToggle("fast"), t(this).toggleClass("is-active")
    }), u.on("click", function () {
        r.toggleClass("opened")
    }), t(window).on("scroll", function (t) {
        r.removeClass("opened")
    }), t(window).on("click", function (e) {
        t(e.target).closest(r).length || t(e.target).closest(c).length || !r.hasClass("opened") || r.removeClass("opened"), t(e.target).closest(a).length || t(e.target).closest(l).length || "none" === r.css("style") || (a.slideUp("fast"), l.removeClass("is-active"))
    }), o.easeScroll({frameRate: 150, animationTime: 1200, stepSize: 130});
    var h = t(".js-header"), d = h.data("scroll-offset");
    t(window).scroll(function () {
        t(this).scrollTop() > d ? h.addClass("header-sm pos-fixed") : h.removeClass("header-sm pos-fixed")
    });
    var p = t(".search-box"), f = t(".search-box .js-btn-search"), m = t(".search-box .input-holder");
    f.on("click", function () {
        p.toggleClass("search-box-open"), m.hasClass("fadeInUp") ? m.removeClass("fadeInUp").addClass("fadeOutDown") : m.hasClass("fadeOutDown") ? m.removeClass("fadeOutDown").addClass("fadeInUp") : m.addClass("fadeInUp")
    }), t(window).on("click", function (e) {
        t(e.target).closest(p).length || t(e.target).closest(f).length || !p.hasClass("search-box-open") || (p.removeClass("search-box-open"), m.hasClass("fadeInUp") ? m.removeClass("fadeInUp").addClass("fadeOutDown") : m.hasClass("fadeOutDown") ? m.removeClass("fadeOutDown").addClass("fadeInUp") : m.addClass("fadeInUp"))
    });
    var g = t(".mini-shopcart"), v = t(".js-btn-cart");
    g && v && (v.on("click", function () {
        g.toggleClass("open")
    }), t(window).on("click", function (e) {
        t(e.target).closest(g).length || t(e.target).closest(v).length || g.removeClass("open")
    }));
    var y = t(".isotope-grid"), w = t(".filter-tope-group");
    w.each(function () {
        w.on("click", "li", function () {
            var e = t(this).attr("data-filter");
            y.isotope({filter: e})
        });
        var e = t(".filter-tope-group");
        e.on("click", "li", function () {
            e.find(".active").removeClass("active"), t(this).addClass("active")
        })
    });
    var b = y.each(function () {
        t(this).isotope({itemSelector: ".isotope-item", percentPosition: !0, masonry: {columnWidth: ".isotope-item"}})
    });
    b.imagesLoaded().progress(function () {
        b.isotope("layout")
    });
    var _ = t(".owl-carousel");
    _.each(function () {
        var e = {
            items: 3,
            margin: 0,
            ...
            autowidth: !1,
            nav: !1,
            navtext: ["<i data-toggle='tooltip' title='Previous' class='fa fa-angle-left'></i>", "<i data-toggle='tooltip' title='Next' class='fa fa-angle-right'></i>"],
            dots: !1,
            dotsdata: !1,
            autoplay: !1,
            smartspeed: 650,
        ...
        for (var i in e)e.hasOwnProperty(i) && null != t(this).attr("data-carousel-" + i) && (e[i] = t(this).data("carousel-" + i));
        t(this).owlCarousel({
            margin: e.margin,
            loop: e.loop,
            center: e.center,
            mouseDrag: e.mousedrag,
            touchDrag: e.touchdrag,
            pullDrag: e.pulldrag,
            nav: e.nav,
            navText: e.navtext,
            dots: e.dots,
            dotsData: e.dotsdata,
            autoplay: e.autoplay,
            smartSpeed: e.smartspeed,
            animateIn: e.animatein,
            animateOut: e.animateout,
            autoWidth: e.autowidth,
            responsive: {
                0: {items: e.xs},
                480: {items: e.sm, autoplay: !1, touchDrag: !1, pullDrag: !1},
                768: {items: e.md},
                992: {items: e.lg},
                1200: {items: e.items}
            }
    ...
    var x = t(".matchHeigh");
    x && x.matchHeight(), _.on("refreshed.owl.carousel", function () {
        t.fn.matchHeight._update()
    }), function () {
        t(".parallax").each(function () {
            var e = t(this).attr("data-background");
            void 0 !== e && t(this).css("background-image", "url(" + e + ")")
        })
    }(), t(window).resize(e), t(window).focus(e), e(), o.hasClass("touch") || (t(window).resize(i), t(window).scroll(i), i());
    var C = document.getElementById("pricepicker");
    if (void 0 != C) {
        noUiSlider.create(C, {start: [50, 200], connect: !0, range: {min: 0, max: 1e3}});
        var S = [document.getElementById("lower-value"), document.getElementById("upper-value")];
        C.noUiSlider.on("update", function (t, e) {
            S[e].innerHTML = "$" + t[e]
        })
    }
    var T = t("[data-view=list]"), E = t("[data-view=grid]");
    T.hasClass("current") ? n.addClass("shop-view-list") : E.hasClass("current") && n.addClass("shop-view-grid"), T.on("click", function () {
        return t(this).hasClass("current") || (n.removeClass("shop-view-grid").addClass("shop-view-list"), E.removeClass("current"), t(this).addClass("current")), t.fn.matchHeight._update(), !1
    }), E.on("click", function () {
        return t(this).hasClass("current") || (n.removeClass("shop-view-list").addClass("shop-view-grid"), T.removeClass("current"), t(this).addClass("current")), t.fn.matchHeight._update(), !1
    });
    var k = {
        ".chosen-select.no-search": {disable_search_threshold: 10, width: "100%"},
        ".chosen-select": {width: "100%"}
    };
    for (var z in k)k.hasOwnProperty(z) && t(z).chosen(k[z]);
    t(".quantity").each(function () {
        var e = t(this), i = e.find('input[type="number"]'), n = e.find(".increase"), o = e.find(".decrease"), s = i.attr("min"), r = i.attr("max");
        n.click(function () {
            var t = parseFloat(i.val()), n = void 0;
            n = t >= r ? t : t + 1, e.find("input").val(n), e.find("input").trigger("change")
        }), o.click(function () {
            var t = parseFloat(i.val()), n = void 0;
            n = t <= s ? t : t - 1, e.find("input").val(n), e.find("input").trigger("change")
        })
    });
    var D = t(".accordion");
    D && D.each(function () {
        t(this).accordion({transitionSpeed: 400, transitionEasing: "ease-in-out"})
    }), t(".remodal").remodal(), t('[data-toggle="tooltip"]').tooltip(), t("#dropStyle").on("change", function () {
        var e = "";
        t("#dropStyle").find("option:selected").each(function () {
            e += t(this).text()
        }), "Dark" == e ? t(".js-header-style").addClass("navbar-dropdow-dark").removeClass("navbar-dropdow-light") : "Light" == e && t(".js-header-style").addClass("navbar-dropdow-light").removeClass("navbar-dropdow-dark")
    });
    var I = t("#js-pane-shipping");
    t("#ckcShipping").on("change", function () {
        this.checked ? I.slideDown("fast") : I.slideUp("fast")
    }), t(".btn-close-panel").on("click", function () {
        t(".control-panel").toggleClass("open")
        ...
        loadingInner: '<div class="single6"></div>',
        timeout: !1,
        timeoutCountdown: 5e3,
        onLoadEvent: !0,
        browser: ["animation-duration", "-webkit-animation-duration"],
